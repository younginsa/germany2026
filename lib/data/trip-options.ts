...
export const tripOptions: TripOption[] = [
  ...
  },
  {
    ...
    costUnit: "4인",
    costPerFamily: "약 800~970만원",
    costGroup: "성인 2 + 아이 2 (7·3세) · 4인 총액",
    costNote:
      "항공 ~330만 + 크루즈 3박 4인 공식가 $1,946~3,371 (인사이드~오션뷰, 출항일별 요금표 참고) + 싱가포르 호텔 3박 ~90만 + 식비·교통 ~100만. 12/21 항차는 12/7 대비 오션뷰 +30%",
    ...
    detail: {
      intro:
        "마리나베이 크루즈 센터에서 디즈니 어드벤처에 오르는 순간, 여행 준비가 끝나요. 이동도, 식당 검색도, '오늘 뭐 하지'도 없어요. 아이들은 연령별 키즈클럽으로, 어른은 선베드로. 저녁엔 온 가족이 브로드웨이급 공연을 보고, 복도에서 미키를 만나면 그날은 성공한 날이에요. 디즈니 어드벤처는 2025년 12월 싱가포르에서 취항한 아시아 최초의 디즈니 크루즈로, 중간 기항 없이 바다 위에서만 보내는 '크루즈 투 노웨어' 항로예요 — 하선·재승선 절차가 없으니 아이들을 데리고도 온전히 쉬는 일정이 됩니다. 배 안은 디즈니·마블·픽사 테마 구역으로 나뉘어 있어서, 3박 내내 '오늘은 어느 동네에서 놀까'를 고르는 재미가 있어요. 유일한 숙제는 예약 타이밍 — 12월 항차는 가장 먼저 매진되는 구간이라, 아래 예약 가이드를 참고해 서두르는 게 좋아요.",
      flowFirst: true,
      notice: {
      ...
      tables: [
        {
          afterFlow: true,
          title: "🗓️ 확정 일정(12/23~29) 3가지 플랜 — 전 1박 + 후 1박, 어디서 자고 뭘 할까",
          intro:
            "크루즈 12/24~28(크리스마스 항차 4박) 확정 기준. 승선 전 1박·하선 후 1박을 어떻게 쓰느냐로 세 가지 플랜을 비교했어요.",
          columns: [
            "✅ A · 마리나베이 올인 (이동 최소)",
            "B · 뒤는 센토사 (물놀이 피날레)",
            "C · 공항 베이스 (실용형)",
          ...
          rows: [
            {
              label: "12/23 수 · 도착",
              cells: [
                "시내권(마리나베이·시티홀) 호텔 1박 — 저녁 도착이면 짐 풀고 야경 산책, 여유 있으면 원더랜드",
                "A와 동일 — 첫날은 시내권 1박이 정답 (센토사까지 갈 이유가 없어요)",
                "밤 도착이면 창이 공항권(크라운 플라자 창이 등) 1박 — 공항에서 10분, 도착 직후 이동 스트레스 제로",
              ],
            },
            {
              label: "12/24 목 · 승선",
              cells: [
                "오전 머라이언 파크·마리나베이 산책 → 정오 전 터미널行 택시 5~10분, 일찍 승선해 점심부터 선내에서",
                "A와 동일",
                "오전 주얼 창이(레인 보텍스·캐노피 파크) → 터미널까지 20분 — 아침을 공항에서 쓰는 대신 시내 이동이 없어요",
              ],
            },
            {
              label: "12/24~28 · 크루즈 4박",
              cells: [
                "🎄 크리스마스 항차 공통 — 트리 점등식, 산타 그리팅, 12/25 특별 메뉴를 바다 위에서",
                "공통",
                "공통",
              ],
            },
            {
              label: "12/28 월 · 하선",
              cells: [
                "하선 → 같은 시내권 호텔 재체크인(택시 5~10분) — 낮엔 호텔 풀·낮잠, 저녁은 원더랜드 마지막 기회 or 스펙트라 분수쇼",
                "하선 → 센토사 15~20분, 라사 센토사·하드락 체크인 — 오후 내내 키즈풀·비치·모래놀이로 크루즈 무드 연장",
                "하선 → 낮에 가든스 바이 더 베이(실내 돔은 시원해요) → 오후 공항권 호텔 체크인, 저녁은 호텔 풀",
              ],
            },
            {
              label: "12/29 화 · 귀국",
              cells: [
                "레이트 체크아웃 요청 → 주얼 창이 반나절(폭포·캐노피 파크) → 출국",
                "오전 수영 한 번 더 or SEA 아쿠아리움 → 공항 30분 — 출발 3시간 전엔 출발",
                "아침 느긋하게 → 셔틀·도보로 터미널 — 이동 변수 자체가 없어요",
              ],
            },
            {
              label: "이런 가족에게",
              cells: [
                "이동·짐 스트레스 최소, 호텔도 한 동네 — 하선일 아이 컨디션이 걱정이라면 이 플랜",
                "물놀이가 최우선 — '호텔 수영장이 여행의 전부'인 미취학에게 만족도 1위, 대신 이동 한 번 추가",
                "밤 도착·오전 출발 항공과 궁합 최고 — 관광 욕심을 내려놓은 실용주의",
              ],
            },
          ],
          note: "추천은 A안 — 하선일 아이 컨디션이 최대 변수라 이동을 아끼는 게 남는 장사예요. 물놀이 욕심이 있으면 B안. 셋 다 공통 준비물: 12/23·28 호텔은 무료취소로 지금 확보(연말 최성수기), 원더랜드는 날짜 지정 예매, 귀국 항공은 12/29로 확정이에요.",
        },
        {
          title: "싱가포르, 크루즈 전에 둘까 후에 둘까?",
          intro:
            "검토 히스토리예요 — 최종은 '전 1박 + 후 1박'으로 확정 (위 3가지 플랜 표 참고). 아래는 배치 판단의 근거로 남겨둬요.",
        ...
        {
          title: "💰 출항일별 공식 요금 — 4인 총액 (3박 · 세금 포함)",
          intro:
            "디즈니 공식 예약 사이트에서 우리 인원(성인 2 + 아이 2)으로 직접 조회한 실제 총액이에요 (2026년 8월 26일 기준, 세금·항만세 포함). 3박은 전부 월~목 항차입니다.",
          compact: true,
          columns: ["인사이드", "오션뷰", "베란다", "컨시어지"],
          rows: [
            {
              label: "12/7–10 (월)",
              cells: ["$1,946 (~272만)", "$2,469 (~346만)", "$2,673 (~374만)", "$5,409"],
            },
            {
              label: "12/14–17 (월)",
              cells: ["$2,383 (~334만)", "$2,609 (~365만)", "$2,773 (~388만)", "$5,625"],
            },
            {
              label: "12/21–24 (월) · 이브 하선",
              cells: ["$2,472 (~346만)", "$3,205 (~449만)", "$3,367 (~471만)", "$6,510"],
            },
            {
              label: "12/28–31 (월) · 연말",
              cells: ["$2,549 (~357만)", "$3,371 (~472만)", "$3,620 (~507만)", "$7,215"],
            },
          ],
          note: "환산은 1,400원/USD 기준. 12/21 항차는 12/7 대비 인사이드 +27%, 오션뷰 +30% — 12월 초로 당기는 게 최대 절약 레버예요. ⚠️ 크리스마스 당일을 배에서 보내는 12/24(목) 출발 4박 항차는 예약 화면의 '1 to 3' 필터를 '4'로 바꿔야 보입니다!",
          photos: [
            {
              src: "/sweety/fare-3night.jpg",
              alt: "공식 사이트 3박 항차 요금 화면",
              caption: "원본 스크린샷 — 공식 예약 화면 3박 항차 4개 (표의 출처)",
            },
          ],
        },
        {
          title: "💰 출항일별 공식 요금 — 4박 (목~월 · 4인 총액 · 세금 포함)",
          intro:
            "'4박' 필터에서 보이는 목요일 출발 항차들이에요. 12/24 출발이 크리스마스 당일을 배에서 보내는 바로 그 항차 — 컨시어지는 이미 매진이에요.",
          compact: true,
          columns: ["인사이드", "오션뷰", "베란다", "컨시어지"],
          rows: [
            {
              label: "12/3–7 (목)",
              cells: [
                "$2,294 (~321만) · 프로모 (정가 $2,857)",
                "$3,300 (~462만)",
                "$3,029 (~424만) · 프로모 (정가 $3,728)",
                "$7,340",
              ],
            },
            {
              label: "12/10–14 (목)",
              cells: ["$2,492 (~349만)", "$3,241 (~454만)", "$3,521 (~493만)", "$7,338"],
            },
            {
              label: "12/17–21 (목)",
              cells: ["$2,868 (~402만)", "$3,744 (~524만)", "$4,068 (~570만)", "$8,516"],
            },
            {
              label: "🎄 12/24–28 (목) · 크리스마스 항해",
              cells: ["$3,763 (~527만)", "$4,923 (~689만)", "$6,108 (~855만)", "매진"],
            },
          ],
          note: "크리스마스 4박(12/24)은 12/10 4박 대비 인사이드 +51% — 컨시어지가 이미 매진인 걸 보면 지금도 팔리는 중이에요. 재미있는 발견 둘: 12/3 항차는 프로모 중이라 베란다($3,029)가 오션뷰($3,300)보다 싸고, 12월엔 '4박 랑카위(말레이시아) 기항 크루즈'($3,684~)도 1회 있어요 — 기항지 있는 항차를 원하면 이쪽도 후보.",
          photos: [
            {
              src: "/sweety/fare-4night.jpg",
              alt: "공식 사이트 4박 항차 요금 화면",
              caption: "원본 스크린샷 — 4박 항차, 🎄 12/24 크리스마스 항해 포함 (표의 출처)",
            },
          ],
        },
        {
          ...
          intro:
            "위 표의 공식 조회가는 이미 4인 총액(세금 포함)이라, 여기에 더해질 것만 알면 돼요.",
          columns: ["항목", "금액", "비고"],
          rows: [
            {
              label: "1 · 크루즈 요금",
            ...
            },
            {
              label: "4 · 배 바깥 비용",
              cells: [
                "항공 + 싱가포르 호텔 3박 + 시내 식비·교통",
                "약 420~520만원",
                "항공 ~330만(성수기 직항) + 호텔 ~90만 + 식비·교통 ~100만",
              ],
            },
            {
              label: "= 4인 총 예상",
              cells: [
                "인사이드 기준 약 800만 / 오션뷰 약 870~970만",
                "—",
                "출항일에 따라 (12월 초가 최저, 연말이 최고)",
              ],
            },
          ],
          note: "크루즈 요금은 실시간 변동제라 위 조회가도 예약 시점에 달라질 수 있어요 — 날짜를 정했으면 빨리 잡는 게 답입니다.",
        },
        {
          title: "승선 전 싱가포르 3일 플랜 (참고용)",
          intro:
            "전 2박+후 1박으로 검토하던 시절의 플랜이에요 — 확정안(전 1박)에선 DAY 2의 동물원 대신 원더랜드·주얼 창이만 남겨요. 일정이 늘어날 때를 대비해 남겨둡니다.",
          columns: ["오전", "오후", "저녁"],
          rows: [
            {
              label: "DAY 1 · 도착",
          ...
          note: "확정 일정(12/23~29·전 1박+후 1박)의 일자별 플랜은 여행의 흐름 아래 '3가지 플랜' 표에 있어요.",
        },
        {
          title: "✈️🏨 항공·숙소 — 여행사에 맡길까, 직접 예약할까?",
          intro:
            "12/23 도착 → 12/29 귀국, 어른 2 + 미취학 2 기준. 앞뒤 숙박과 항공을 어느 채널로 예약할지 비교예요.",
          columns: [
            "여행사 통합 (크루즈+항공 묶음)",
            "직접 예약 (DIY)",
            "✅ 하이브리드 (추천)",
          ...
          rows: [
            {
              label: "이렇게 예약해요",
              cells: [
                "하나투어 등의 '디즈니 크루즈+왕복항공' 상품에 하선 후 호텔 2박을 추가 수배 상담 — 전화 한 통으로 전 일정 정리",
                "항공은 스카이스캐너·항공사 직판, 크루즈는 공식/에이전시, 호텔은 아고다·호텔 직판 — 전부 각자 예약",
                "크루즈(+항공)는 에이전시 묶음으로, 하선 후 호텔 2박·입장권만 직접",
              ],
            },
            {
              label: "가격",
              cells: [
                "묶음 특가·하드블록 좌석이 있으면 유리할 수 있어요. 다만 호텔 마진이 포함돼 총액은 보통 직접보다 높아요",
                "총액 최저 가능성이 가장 높아요. 인천-싱가포르 왕복은 평시 인당 40~70만원대인데 12월 말엔 크게 뛰니 '빨리 사는 것'이 최대 할인이에요",
                "항공·크루즈는 프로모 활용, 호텔은 무료취소가로 먼저 잡고 특가 뜨면 갈아타기",
              ],
            },
            {
              label: "일정 유연성",
              cells: [
                "'12/28 하선 후 2박' 같은 비정형 일정은 정형 패키지가 없어 개별 수배 영역 — 호텔 선택지가 제한적이에요",
                "오전 하선 시각, 12/30 밤 비행까지 우리 일정에 1:1 맞춤",
                "고정할 건 크루즈뿐 — 나머지는 전부 자유",
              ],
            },
            {
              label: "아이 배려",
              cells: [
                "요청 사항 전달은 되지만, 키즈클럽·키즈풀 있는 호텔을 상품 안에서 고르긴 어려워요",
                "키즈 시설 기준으로 호텔을 직접 비교 선택 — 샹그릴라(시내)·라사 센토사·하드락(센토사)",
                "호텔 선택권은 직접 예약 쪽이 가져요 — 아래 가이드의 3강 중에서",
              ],
            },
            {
              label: "문제 대응",
              cells: [
                "한국어 상담·비상 연락 창구 — 여행사 최대 강점",
                "본인이 처리해요. 다만 싱가포르는 영어·인프라가 좋아 자유여행 난이도 최하급",
                "크루즈 이슈는 에이전시가, 시내 이슈는 직접",
              ],
            },
            {
              label: "취소·변경",
              cells: [
                "여행사 약관 일괄 적용 — 특가 상품일수록 수수료가 빡빡해요",
                "호텔은 무료취소 요금제 선택 가능, 항공은 운임 규정별 상이",
                "호텔은 무료취소로, 크루즈 취소 규정만 캘린더에 표시",
              ],
            },
          ],
          note: "결론: '승선 전 1박 + 하선 후 1박' 같은 비정형 구간은 정형 패키지가 없어 전부 여행사에 맡길 실익이 적어요. 크루즈+항공은 에이전시 묶음(한국어 상담·프로모션)을 활용하되, 앞뒤 호텔과 입장권은 키즈 시설을 보고 직접 고르는 하이브리드를 추천해요. 12월 말은 연말 최성수기 — 항공보다 호텔이 먼저 마르니, 무료취소 조건으로 지금 걸어두는 게 1순위예요.",
        },
        {
          title: "🛏️ 객실 테마 맵 — 룸테마 시트 요약",
          intro:
            "sweetyref의 룸테마 시트(객실 번호별 전수 데이터)를 집계했어요. 층과 카테고리로 아이 최애 캐릭터 방을 노려보세요.",
      ...
      flow: [
        {
          heading: "🌴 PART 1 — DAY 1 (12/23 수) · 도착, 워밍업 1박",
          body: "도착하면 주얼 창이의 실내 폭포부터 — 공항이 곧 첫 관광지예요. 시내 호텔 체크인 후 컨디션이 되면 저녁엔 가든스 바이 더 베이 크리스마스 원더랜드로. 인공눈 내리는 슈퍼트리 아래에서 크리스마스 기분을 미리 충전하고 다음 날 배에 오르는 순서예요.",
        },
        {
          heading: "🚢 PART 2 — DAY 2 (12/24 목) · 승선일, 첫 미션은 앱 예약",
          body: "마리나베이 크루즈 센터 체크인은 오전에 일찍 하는 게 유리해요 — 점심부터 선내 뷔페와 수영장을 쓸 수 있으니 반나절을 버는 셈이에요. 승선하자마자 디즈니 크루즈 앱으로 캐릭터 그리팅과 공연을 예약하는 게 첫 미션. 크리스마스 이브 밤, 출항과 함께 트리 점등식으로 홀리데이 항차가 시작돼요.",
        },
        {
          heading: "🚢 PART 2 — DAY 2–6 (12/24~28) · 크리스마스 항차 4박",
          body: "크리스마스 당일을 바다 위에서! 낮엔 워터슬라이드와 수영장, 저녁엔 매일 다른 테마 레스토랑을 도는 로테이션 다이닝 — 서버가 같이 이동하며 아이들 취향을 기억해줘요. 아이들이 연령별 키즈클럽에 있는 동안 어른은 성인 전용 구역에서 진짜 휴가를 보내고, 밤엔 온 가족이 디즈니·마블 쇼와 산타 그리팅. 식사·공연·키즈클럽 전부 요금 포함이에요.",
        },
        {
          heading: "🌴 PART 3 — DAY 6–7 (12/28 월~29 화) · 하선, 마무리 1박",
          body: "12/28 오전 하선 후 호텔에 짐을 맡기고 마지막 하루를 보내요 — 어디서 어떻게 보낼지는 아래 3가지 플랜 비교에서 골라요. 12/29 귀국편까지, 크루즈 여운을 안고 마무리.",
        },
      ],
      ...
      booking: {
        ...
        steps: [
          ...
          {
            heading: "3 · 채널 선택 & 결제",
            body: "공식 사이트는 예약금(요금의 일부)을 걸고 잔금은 출항 전 마감일까지 — 마감일과 취소 수수료 규정을 예약 화면에서 꼭 확인하세요. 한국 에이전시(마이리얼트립·KKday·클룩 등)는 한국어 상담과 선내 크레딧(OBC)·프로모션이 장점이라 견적을 나란히 비교해보는 걸 추천해요. ⚠️ 실측 비교(12/7 항차, 2026년 8월 기준): 국내 여행사 크루즈 단품은 전 연령 동일 단가(예: 인사이드 1인 115만 → 4인 460만)라, 3·4번째 인원을 크게 할인해주는 공식 직예약 4인 총액($1,946 ≈ 272만)이 우리 가족 구성엔 약 190만원 저렴했어요. 롯데관광의 티웨이 항공+크루즈 결합 자유 패키지(6일)는 항공 시세가 오를 때 견적 비교 가치가 있어요 (☎ 1577-3000).",
          },
          {
            heading: "4 · 출항 전 준비",
        ...
        note: "가격·취소 규정은 항차와 객실 등급, 예약 시점에 따라 크게 달라져요. 성인 2 + 아이 2는 오션뷰 4인실 정원에 딱 맞으니, 예약 인원(3세 포함 4명)만 정확히 입력하면 돼요. 실제 요금 화면 스크린샷은 위 요금표 아래에 붙여뒀어요.",
      },
      guides: [
        {
        ...
        {
          title: "🎫 크루즈+항공 묶음 상품 & 프로모션 — 지금 팔리는 것들",
          intro:
            "'크루즈+항공을 여행사에 맡긴다'면 실제 선택지는 이거예요. 프로모션은 수시로 바뀌니 예약 직전에 각 링크에서 재확인하세요 (2026년 8월 검색 기준).",
          steps: [
            {
              heading: "하나투어 — 크루즈+왕복항공 자유여행 6일",
              body: "디즈니 어드벤처 3박 + 왕복항공권을 묶은 자유여행형 상품. 크루즈 ONLY(내측 3박/4박) 상품도 따로 있어요. 카드 결제 시 마일리지 적립(1~3%)이 되는 게 소소한 장점.",
            },
            {
              heading: "롯데투어 — 티웨이항공 연계 6일",
              body: "크루즈 예약 시 항공 할인코드를 주고, 전용 링크에서 티웨이 항공권을 할인가로 잇는 방식이에요. 항공+크루즈를 한 번에 정리하면서도 일정은 자유.",
            },
            {
              heading: "KKday — 확보 객실 + 호텔 1박 증정 프로모션",
              body: "KKday가 미리 확보한 객실이라 인기 출항일도 매진 걱정이 적고, 크루즈 예약 시 싱가포르 호텔 1박 증정 프로모션을 진행해왔어요 — 우리처럼 하선 후 숙박이 필요한 일정엔 실질 할인이에요. 항공 프로모션 페이지도 따로 운영.",
            },
            {
              heading: "인터파크(NOL)·노랑풍선·마이리얼트립",
              body: "인터파크는 크루즈 6일 패키지(오션 베란다 등 등급별)와 3박4일·4박5일 단품, 노랑풍선은 디즈니 어드벤처 프로모션관을 운영해요. 마이리얼트립은 예약 후 48시간 내 디즈니 공식 확인번호를 주는 크루즈 단품 — 항공은 직접 조합이에요.",
            },
            {
              heading: "고르는 법 — 우리 일정 기준",
              body: "12/28 하선 + 2박 연장이라면: ① 호텔 1박 증정형(KKday류)은 증정 숙박을 하선 후 첫날로 쓸 수 있는지 먼저 문의 ② 항공 묶음형(하나투어·롯데)은 귀국편을 12/30로 바꿀 수 있는지(오픈전 확정) 확인 ③ 어느 쪽이든 12월 말 항차의 오션뷰 4인실(어른2+아이2 정원 딱) 재고가 있는지가 1차 필터예요.",
            },
          ],
          links: [
            {
              label: "하나투어 — 크루즈+왕복항공 자유여행 6일",
              url: "https://www.hanatour.com/trp/pkg/CHPC0PKG0200M200?pkgCd=ASC802260705KEB",
            },
            {
              label: "롯데투어 — 티웨이항공+크루즈 6일",
              url: "https://lottetour.com/evtDetail/847/1207/4077/4078?evtCd=B05H260614TW000",
            },
            {
              label: "KKday — 디즈니 크루즈 프로모션관",
              url: "https://www.kkday.com/ko/promo/disneyadventurekr",
            },
            {
              label: "KKday — 항공 프로모션",
              url: "https://www.kkday.com/ko/promo/sgdisney",
            },
            {
              label: "인터파크 NOL — 디즈니 어드벤처 6일 패키지",
              url: "https://travel.interpark.com/package/products/ASSGP00777",
            },
            {
              label: "노랑풍선 — 디즈니 어드벤처 프로모션관",
              url: "https://mpkg.ybtour.co.kr/promotion/promotionDetail.yb?mstNo=20000031130",
            },
          ],
          note: "프로모션(호텔 증정·할인코드·OBC)은 시즌마다 바뀌고 조기 종료돼요. 견적은 2~3곳에 같은 조건(12월 항차·오션뷰 4인)으로 받아서 나란히 비교하는 게 가장 빨라요. ⚠️ 실측 예시: 참좋은여행 크루즈 단품(12/7 인사이드)은 1인 115만 · 전 연령 동일 단가 → 4인 460만으로, 3·4번째 인원을 할인하는 공식 직예약(4인 $1,946 ≈ 272만)보다 약 190만 비쌌어요. 여행사 견적은 반드시 '4인 총액'으로 받아 공식가와 비교하세요.",
        },
        {
          title: "🏙️ 하선 후 싱가포르 — 아이랑 시티 스테이 (숙소·동선 가이드)",
          intro:
            "12/28 오전 하선 → 12/29 귀국, 어른 2 + 미취학 2 기준 숙소·동선 가이드예요. 일자별 플랜은 위 '3가지 플랜' 표에서 골랐다면, 여기선 어디에 묵고 어떻게 움직일지를 정해요.",
          steps: [
            {
              heading: "숙소 위치 — 하선 후 어디가 편할까",
              body: "배에서 내리는 곳은 마리나베이 크루즈 센터(마리나 사우스)예요. 택시 기준 ① 마리나베이·시티홀 시내권 5~10분 — 하선 후 가장 빠르고, 가든스 바이 더 베이·원더랜드가 코앞이라 연말 이벤트 동선 최강 ② 센토사 15~20분 — 리조트 무드를 이어가는 선택, 유니버설·아쿠아리움·비치가 걸어서 ③ 오차드 20~25분 — 쇼핑과 라이트업의 중심이지만 터미널에선 가장 멀어요. 2박이면 호텔 이동 없이 한 곳 고정이 정답: 물놀이·키즈클럽이 우선이면 센토사, 연말 야경·이벤트가 우선이면 시내권이에요.",
            },
            {
              heading: "숙소 — '키즈 프로그램' 있는 호텔 3강",
              body: "① 샹그릴라 싱가포르(오차드): '가족여행 성지'로 불리는 곳 — 대형 야외 풀과 워터슬라이드, 실내 놀이공간, 패밀리 테마룸까지 미취학 저격이에요. ② 샹그릴라 라사 센토사: 키즈클럽 + 키즈풀 + 프라이빗 비치에 아이 전용 뷔페 코너까지 — 후기마다 '아이가 제일 좋아한 호텔'로 꼽혀요. ③ 하드락 호텔(RWS): 모래바닥 수영장이 시그니처, 유니버설·SEA 아쿠아리움이 도보권. 가성비가 우선이면 스위소텔 더 스탬포드(시내 중심·넓은 객실)도 후보예요.",
            },
            {
            ...
            },
            {
              ...
              body: "레이트 체크아웃을 요청하고 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 실내 폭포, 캐노피 파크의 미끄럼틀·미로가 미취학에게 딱. 센토사 베이스였다면 출발 전 오전 수영 한 번이 아이들의 마지막 선물. 밤 비행이면 아이들은 이륙과 함께 잠들고, 12/31 카운트다운 인파가 몰리기 전에 빠져나오는 일정이라 혼잡 리스크도 낮아요.",
            },
          ],
          links: [
            {
            ...
            {
              label: "하나투어 — 디즈니 크루즈+왕복항공 자유여행 상품",
              url: "https://www.hanatour.com/trp/pkg/CHPC0PKG0200M200?pkgCd=ASC802260705KEB",
            },
            {
          ...
          note: "12/23·12/28 숙박은 연말 최성수기 — 키즈 특화 호텔(특히 라사 센토사·샹그릴라 패밀리룸)이 가장 먼저 매진돼요. 무료취소 조건으로 지금 걸어두고, 항공 귀국편(12/29)도 같이 확정하는 게 순서예요.",
        },
      ],
      gallery: [
        {
