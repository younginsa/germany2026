...
export const tripOptions: TripOption[] = [
  ...
  },
  {
    ...
    costNote:
      "크루즈 확정 $6,260.24 (≈877만 · 15562 바다 베란다 4인·세금 포함, 예약금 $606 결제) + 항공 ~330만(성수기 직항 추정) + 호텔 2박 ~60만 + 식비·교통 ~60만",
    ...
    detail: {
      checklist: [
        { label: "크루즈 예약 — 12/24 항차 · 15562 베란다", done: true },
        { label: "다이닝 얼리(1부) 웨이트리스트 요청" },
        { label: "항공권 — 12/23 도착 · 12/29 귀국" },
        { label: "호텔 12/23·28 — 같은 호텔, 무료취소" },
        { label: "크루즈 잔금 — 마감일 캘린더 알림" },
        { label: "여행자보험 가입 (국내 상품)" },
        { label: "원더랜드 날짜 지정 예매" },
        { label: "온라인 체크인 + SG 입국카드 (출발 직전)" },
      ],
      intro:
        "마리나베이 크루즈 센터에서 디즈니 어드벤처에 오르는 순간, 여행 준비가 끝나요. 이동도, 식당 검색도, '오늘 뭐 하지'도 없어요. 아이들은 연령별 키즈클럽으로, 어른은 선베드로. 저녁엔 온 가족이 브로드웨이급 공연을 보고, 복도에서 미키를 만나면 그날은 성공한 날이에요. 디즈니 어드벤처는 2025년 12월 싱가포르에서 취항한 아시아 최초의 디즈니 크루즈로, 중간 기항 없이 바다 위에서만 보내는 '크루즈 투 노웨어' 항로예요 — 하선·재승선 절차가 없으니 아이들을 데리고도 온전히 쉬는 일정이 됩니다. 배 안은 디즈니·마블·픽사 테마 구역으로 나뉘어 있어서, 4박 내내 '오늘은 어느 동네에서 놀까'를 고르는 재미가 있어요. 그리고 — 예약 끝났어요! 🎉 12/24 출항 크리스마스 항차 4박, 15층 바다 베란다 15562(스파이더맨 테마)로 확정. 크리스마스 이브와 당일을 바다 위에서, 디즈니 캐릭터들과 보내는 여행이 진짜가 됐습니다. 이제 남은 숙제는 항공·호텔·다이닝 시간 — 아래 체크리스트를 순서대로 처리하면 돼요.",
      flowFirst: true,
      notice: {
      ...
      tables: [
        ...
        },
        {
          ...
          intro:
            "인천-싱가포르 직항 기준, 우리 일정에 맞는 편만 추렸어요. 가격은 연말 성수기 왕복 추정치(어른 1인) — 소아(만 2~11)는 FSC 기준 어른의 약 75%예요.",
          columns: [
            "대한항공 (KE)",
            "싱가포르항공 (SQ)",
            "티웨이항공 (TW)",
          ...
          rows: [
            {
              label: "12/23 가는 편",
              cells: [
                "KE643 14:35→20:25 (저녁 도착) 또는 전날 밤 KE647 23:10→새벽 5시 도착 — 하루를 온전히 써요",
            ...
            },
            {
              label: "12/29 오는 편",
              cells: [
                "KE644 22:30→익일 05:45 ⭐ 계획 그대로 '밤 비행' — 주얼 창이 후 저녁 출발",
          ...
          note: "추천 조합: ① 편안 우선 — 가는 편 SQ607(오전) + 오는 편 KE644(밤) 조합처럼 항공사를 나눠 끊는 것도 방법 (편도씩 비교) ② 가성비 — 티웨이 왕복 (귀국 새벽편 날짜 주의) ③ 마일리지·안정 — 대한항공 왕복. ⚠️ 공통: 심야 출발편(00~02시)은 달력상 출발일이 12/30이니 검색할 때 날짜를 하루 넓혀 보세요. 시간표는 시즌마다 바뀌니 발권 전 재확인 — 성수기라 소아 좌석 포함 4석 나란히는 빨리 잡을수록 유리해요.",
        },
        {
          title: "💰 우리 항차 요금 — 🎄 12/24–28 크리스마스 4박 (4인 총액 · 세금 포함)",
          intro:
            "예약 완료한 12/24(목) 출발 크리스마스 항차의 공식 조회가예요. 우리는 바다 베란다급(06B Deluxe Oceanview with Verandah)으로 $6,260.24에 확정했어요.",
          compact: true,
        ...
        },
        {
          ...
          intro:
            "예약 완료 기준으로 확정된 금액과 앞으로 나갈 돈을 정리했어요.",
          columns: ["항목", "금액", "비고"],
          rows: [
            {
              label: "1 · 크루즈 (확정)",
              cells: [
                "$6,260.24",
                "예약금 $606.04 결제 완료",
                "잔금 $5,654.20은 마감일까지 — 미납 시 자동 취소되니 캘린더 알림 필수!",
              ],
            },
            {
              label: "2 · 팁 (자동 부과)",
            ...
            {
              label: "4 · 배 바깥 비용 (예약 전)",
              cells: [
                "항공 + 호텔 2박 + 시내 식비·교통",
                "약 420~480만원 추정",
                "항공 ~330만(성수기 직항, 빨리 잡을수록↓) + 호텔 12/23·28 ~60만 + 식비·교통 ~60만",
              ],
            },
            {
              label: "= 4인 총 예상",
          ...
          note: "다음 결제 순서: ① 항공권 (성수기라 지금이 가장 쌈) ② 호텔 무료취소 예약 (돈 안 나감) ③ 크루즈 잔금 (마감일에 맞춰). 여행자보험은 출발 전 아무 때나.",
        },
        {
          title: "🛏️ 객실 테마 맵 — 우리 방은 🕷️ 스파이더맨 (15562)",
          intro:
            "룸테마 시트(객실 번호별 전수 데이터) 집계예요. 우리가 확정한 15562는 15층 스파이더맨 테마 — 남아 둘 취향 저격으로 골랐어요. 아래는 배 전체 분포 참고용.",
      ...
      flow: [
        {
          ...
          body: "도착하면 주얼 창이의 실내 폭포부터 — 공항이 곧 첫 관광지예요. 시내권(마리나베이·시티홀) 호텔 체크인 후, 저녁 도착이면 짐 풀고 마리나베이 야경 산책. 컨디션이 되면 가든스 바이 더 베이 크리스마스 원더랜드(1/1까지·날짜 지정 예매)로 — 인공눈 내리는 슈퍼트리 아래에서 크리스마스 기분을 미리 충전해요. 호텔은 아래 비교표에서.",
        },
        {
        ...
        },
        {
          ...
          body: "크리스마스 당일을 바다 위에서! 우리 방은 15층 바다 베란다 15562(스파이더맨 테마) — 아침마다 발코니에서 수평선을 보며 시작해요. 낮엔 워터슬라이드와 수영장, 저녁엔 매일 다른 테마 레스토랑을 도는 로테이션 다이닝 — 서버가 같이 이동하며 아이들 취향을 기억해줘요. 아이들이 연령별 키즈클럽에 있는 동안 어른은 성인 전용 구역에서 진짜 휴가를 보내고, 밤엔 온 가족이 디즈니·마블 쇼와 산타 그리팅. 식사·공연·키즈클럽 전부 요금 포함이에요.",
        },
        {
        ...
        },
        {
          ...
          body: "레이트 체크아웃 요청 후 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 폭포와 캐노피 파크 미끄럼틀·미로가 아이들 마지막 코스. 밤 비행이면 이륙과 함께 잠들고, 12/31 카운트다운 인파 전에 빠져나오는 일정이라 혼잡 걱정도 없어요.",
        },
      ],
      ...
      booking: {
        title: "✅ 크루즈 예약 완료 — 남은 체크리스트",
        intro:
          "12/24 크리스마스 항차 4박, 15562 바다 베란다(06B)로 공식 사이트 직예약 완료 (4인 $6,260.24 · 예약금 $606.04 결제). 이제 아래 순서대로 처리하면 여행 준비 끝이에요.",
        steps: [
          {
            heading: "1 · 다이닝 시간 변경 — 지금 바로",
            body: "배정된 저녁이 8:15 PM인데 미취학 둘에겐 너무 늦어요. 예약 관리 화면·전화·채팅으로 얼리 다이닝(1부, 5시 반~6시경) 웨이트리스트를 걸어두세요. 크리스마스 항차라 얼리 경쟁이 치열해서 빠를수록 유리해요.",
          },
          {
            heading: "2 · 크루즈 잔금 — 캘린더 알림 2개",
            body: "잔금 $5,654.20은 마감일까지 결제 — 마감일은 예약 확인 메일·My Reservation에서 확인하고, 2주 전·3일 전 알림을 걸어두세요. 미납 시 자동 취소 + 수수료라 이것만은 절대 놓치면 안 돼요. 완납 할인은 없으니 미리 낼 필요는 없어요.",
          },
          {
            heading: "3 · 항공권 — 12/23 도착 · 12/29 귀국",
            body: "12월 말 성수기라 항공이 다음으로 급해요. 인천-싱가포르 직항(6시간 30분)으로 12/23 도착, 12/29 귀국편. 밤 비행 귀국이면 아이들은 이륙과 함께 잠들어요.",
          },
          {
            heading: "4 · 호텔 — 12/23·12/28 같은 호텔로",
            body: "시내권(스위소텔 1순위) 무료취소 요금제로 두 밤 예약 — 예약 메모에 '크루즈 전후 재방문'을 남기면 얼리 체크인 배려를 받는 경우가 많아요. 연말 성수기라 호텔이 항공보다 먼저 말라요.",
          },
          {
            heading: "5 · 온라인 체크인 & 입국 서류",
            body: "디즈니 크루즈 앱 설치 → 온라인 체크인(여권·결제카드 등록, 승선 시간 선택)은 오픈 시각(한국시간 새벽 1시) 게임이에요 — 스위티 팁 참고. 싱가포르 SG Arrival Card는 도착 3일 전부터 온라인 제출. 여권 유효기간 6개월 이상 확인.",
          },
          {
            heading: "6 · 여행자보험 — 국내 상품으로",
            body: "디즈니 VPP(여행 금액의 ~8%)는 패스했으니, 대신 한국 여행자보험(4인 가족 몇만 원대)으로 해외 의료비·수하물·지연을 커버하세요. 크루즈 선내 의무실 비용도 커버되는 상품인지 확인.",
          },
        ],
        links: [
          {
        ...
        note: "예약번호 등 상세 정보는 DCL 확인 메일과 앱 My Reservation에서 관리해요. 참고: 공식 직예약이 국내 여행사 단품보다 우리 가족 구성(3·4번째 인원 할인)에 유리했던 건 실측으로 확인된 사실 — 잘 고른 선택이에요.",
      },
      guides: [
        {
        ...
        },
        {
          ...
          note: "12/23·12/28 숙박은 연말 최성수기 — 시내권 패밀리 호텔부터 매진돼요. 무료취소 조건으로 지금 걸어두고, 항공(12/23 도착·12/29 귀국)도 같이 확정하는 게 순서예요.",
        },
      ],
      gallery: [
        {
