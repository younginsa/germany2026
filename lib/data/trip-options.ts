  ...
  },
  {
    ...
    detail: {
      checklist: [
        ...
        { label: "여행자보험 가입 (국내 상품 · VPP는 거절 완료)" },
      ...
      tables: [
        {
          ...
          rows: [
            ...
            {
              label: "보험",
              cells: ["디즈니 VPP 어른 2명 모두 거절 처리", "⬜ 국내 여행자보험으로"],
            },
            {
              label: "항공 귀국",
              cells: [
      ...
      booking: {
        ...
        steps: [
          ...
          {
            heading: "7 · 여행자보험 — 국내 상품으로",
            body: "디즈니 VPP는 어른 2명 모두 거절 처리됐어요(예약에 Declined 표시). 대신 한국 여행자보험(4인 가족 몇만 원대)으로 해외 의료비·수하물·지연을 커버하세요. 크루즈 선내 의무실 비용도 커버되는 상품인지 확인.",
          },
        ],
        links: [
          {
