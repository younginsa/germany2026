    ...
    detail: {
      ...
      tables: [
        ...
        },
        {
          ...
          note: "하선 후는 12/28~30 2박3일로 확정 — 예약 채널 비교는 아래 '여행사 vs 직접 예약' 표, 일정은 '하선 후 시티 스테이' 가이드를 봐주세요.",
        },
        {
          title: "✈️🏨 하선 후 2박3일 — 여행사에 맡길까, 직접 예약할까?",
          intro:
            "12/28 하선 → 12/30 귀국, 어른 2 + 미취학 2 기준. 항공·숙소를 어느 채널로 예약할지 비교예요.",
          columns: [
            "여행사 통합 (크루즈+항공 묶음)",
            "직접 예약 (DIY)",
            "✅ 하이브리드 (추천)",
          ...
          note: "결론: 하선 후 2박은 '정형 패키지'가 존재하지 않는 구간이라 전부 여행사에 맡길 실익이 적어요. 크루즈+항공은 에이전시 묶음(한국어 상담·프로모션)을 활용하되, 호텔 2박과 입장권은 키즈 시설을 보고 직접 고르는 하이브리드를 추천해요. 12월 말은 연말 최성수기 — 항공보다 호텔이 먼저 마르니, 무료취소 조건으로 지금 걸어두는 게 1순위예요.",
        },
        {
      ...
      flow: [
        {
          heading: "🌴 PART 1 — DAY 1–2 · 싱가포르 워밍업",
        ...
        {
          heading: "🚢 PART 2 — DAY 3 · 승선일, 첫 미션은 앱 예약",
        ...
        {
          heading: "🚢 PART 2 — DAY 3–5 · 선상 생활, 아이는 클럽으로 어른은 휴가로",
        ...
        {
          heading: "🌴 PART 3 — DAY 6–7 · 싱가포르 마무리",
      ...
      guides: [
        ...
        {
          title: "🏙️ 하선 후 싱가포르 2박3일 (12/28~30) — 아이랑 시티 스테이",
          intro:
            "12/28 오전 하선 → 12/30 귀국, 어른 2 + 미취학 2 기준 플랜이에요. 포인트는 딱 두 가지 — 키즈 프로그램 있는 호텔을 베이스캠프로 잡고, 하루에 큰 일정은 하나만 넣기.",
          steps: [
            {
            ...
            {
              heading: "12/29 · 아이 취향으로 하루",
              body: "센토사 베이스면 유니버설 스튜디오(미니언·슈렉 존이 미취학 존) 또는 SEA 아쿠아리움 + 팔라완 해적선 놀이터. 시내 베이스면 만다이 동물원이나 리버 원더스 — 유모차 동선 좋기로 유명해요. 낮 12~4시는 더우니 몰·실내로 피신하는 게 싱가포르 국룰. 저녁은 호커센터에서 가볍게.",
            },
            {
              heading: "12/30 · 귀국일 — 주얼 창이 피날레",
              body: "레이트 체크아웃을 요청하고 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 실내 폭포, 캐노피 파크의 미끄럼틀·미로가 미취학에게 딱. 밤 비행이면 아이들은 이륙과 함께 잠들고, 12/31 카운트다운 인파가 몰리기 직전에 빠져나오는 일정이라 혼잡 리스크도 낮아요.",
            },
          ],
          links: [
            {
          ...
          note: "12/28~30은 연말 최성수기 — 키즈 특화 호텔(특히 라사 센토사·샹그릴라 패밀리룸)이 가장 먼저 매진돼요. 무료취소 조건으로 지금 걸어두고, 항공 귀국편(12/30 밤)도 같이 확정하는 게 순서예요.",
        },
      ],
      gallery: [
        {
