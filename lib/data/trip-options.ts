...
export const tripOptions: TripOption[] = [
  ...
  },
  {
    ...
    emoji: "🏮",
    badge: "가성비 최고",
    subtitle: "가성비 리조트 휴양 + 호이안 등불 야경",
    image:
      "https://images.unsplash.com/photo-1562005094-c724030f99bd?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG9pJTIwYW4lMjBsYW50ZXJuc3xlbnwwfHwwfHx8MA%3D%3D",
    imageAlt: "호이안 올드타운의 등불",
    period: "5박 6일",
    costPerFamily: "약 400만원",
    costGroup: "두 가족 합계 약 800만원",
    costNote:
      "직항 왕복(인당 50~60만), 패밀리 리조트 2룸 × 5박, 전세차량·식비·마사지 포함 추정",
    flight: "직항 4시간 30분 · 시차 2시간",
    weather: "18~24°C · ⚠️ 우기 — 비 잦고 호이안 침수 가능",
    kidScore: 4,
    kidNote:
      "'경기도 다낭시'로 불릴 만큼 아이 동반 인프라 최고 — 키즈클럽·키즈풀·한식 어디든",
    highlights: [
      "리조트 수영장 (온수풀 여부 확인 필수)",
      "바나힐 테마파크 + 케이블카",
      "호이안 올드타운 등불 거리",
    ],
    pros: [
      "5개 옵션 중 비용 최저 수준",
      "전세차량·마사지 저렴 — 어른도 쉬기 좋음",
      "한국어·한식 인프라로 아이 식사 걱정 없음",
    ],
    cons: [
      "12월은 우기 한복판 — 물놀이·야외일정 제약 큼",
      "비 오면 실내 대안이 리조트뿐",
      "호이안 등불 야경도 우천 시 반감",
    ],
    links: [
      {
        label: "12월 다낭·호이안 가족여행기 (브런치)",
        url: "https://brunch.co.kr/@botongmarketer/490",
      },
      {
        label: "아이 동반 다낭 4박5일 코스 (트립스토어)",
        url: "https://www.tripstore.kr/blog/%EC%95%84%EC%9D%B4-%EB%8F%99%EB%B0%98-%EB%8B%A4%EB%82%AD-4%EB%B0%95-5%EC%9D%BC-%EB%A6%AC%EC%A1%B0%ED%8A%B8-%ED%98%B8%EC%BA%89%EC%8A%A4",
      },
      {
        label: "네이버 블로그 후기 검색",
        url: naverBlogSearch("다낭 12월 아이랑 가족여행 후기"),
      },
    ],
  },
  {
