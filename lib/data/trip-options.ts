      ...
      tables: [
        {
          afterFlow: true,
          compact: true,
          title: "🗓️ 확정 플랜 — 마리나베이 올인 (12/23~29)",
          intro:
            "크루즈 12/24~28(크리스마스 항차 4박) + 앞뒤 시내권 1박씩. '이동 최소' 원칙으로 확정한 플랜이에요 — 호텔도 한 동네, 터미널도 택시 5~10분.",
          columns: ["이렇게 보내요"],
          rows: [
            {
              label: "12/23 수 · 도착",
              cells: [
                "시내권(마리나베이·시티홀) 호텔 체크인 — 저녁 도착이면 짐 풀고 마리나베이 야경 산책, 여유 있으면 가든스 크리스마스 원더랜드 (1/1까지)",
              ],
            },
            {
              label: "12/24 목 · 승선",
              cells: [
                "오전 머라이언 파크·마리나베이 산책 → 정오 전 터미널행 택시 5~10분 — 일찍 승선해 점심부터 선내 뷔페·수영장",
              ],
            },
            {
              label: "12/24~28 · 크루즈 4박",
              cells: [
                "🎄 크리스마스 항차 — 트리 점등식, 산타 그리팅, 12/25 특별 메뉴를 바다 위에서",
              ],
            },
            {
              label: "12/28 월 · 하선",
            ...
            },
            {
              label: "12/29 화 · 귀국",
              cells: [
                "레이트 체크아웃 요청 → 주얼 창이 반나절 (레인 보텍스·캐노피 파크) → 출국",
              ],
            },
            {
              label: "🏨 숙소는 여기",
              cells: [
                "1순위 스위소텔 더 스탬포드 — 넓은 객실·수영장·시티홀 MRT 직결, 4인 가족 가성비 대표. 프리미엄은 콘래드 센테니얼(키즈 웰컴 어메니티·터미널 10분), 12/28 하루만 마리나베이 샌즈 인피니티풀 '피날레 호캉스'도 방법 — 상세 비교는 아래 시티 스테이 가이드에.",
              ],
            },
          ],
          note: "팁: 12/23과 12/28을 같은 호텔로 예약하면 짐 보관·재체크인이 빨라져요 — 예약 메모에 '크루즈 전후 재방문(12/23·12/28)'이라고 남기면 얼리 체크인 배려를 받는 경우가 많아요. 두 밤 모두 무료취소 조건으로 지금 확보하고, 원더랜드는 날짜 지정 예매, 귀국 항공은 12/29로 확정.",
        },
        {
          ...
          rows: [
            ...
            },
            {
              ...
              cells: [
                ...
                "키즈 시설 기준으로 호텔을 직접 비교 선택 — 스위소텔·콘래드 등 시내권 패밀리 호텔",
                "호텔 선택권은 직접 예약 쪽이 가져요 — 아래 가이드의 시내권 4선 중에서",
              ],
            },
            {
              label: "문제 대응",
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: "레이트 체크아웃을 요청하고 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 실내 폭포, 캐노피 파크의 미끄럼틀·미로가 미취학에게 딱. 밤 비행이면 아이들은 이륙과 함께 잠들고, 12/31 카운트다운 인파가 몰리기 전에 빠져나오는 일정이라 혼잡 리스크도 낮아요.",
            },
          ],
          links: [
            {
