 ...
 * 결정: 우리집(어른 2 + 아이 2, 만 6·2세)은 싱가포르 디즈니 크루즈, 친구네(어른 2 + 아이 1)는 독일로 각자 출발.
 * 나머지 카드는 비교 참고용. 비용은 성수기(12월 중순~말) 추정치이며 카드별 costUnit 기준입니다.
 */
...
export interface TripEvent {
  ...
  body: string;
  url?: string;
  /** 소구역 라벨 — 값이 바뀌는 지점마다 구분 헤더가 렌더링돼요 (예: 🚢 크루즈 선상) */
  section?: string;
}
...
export interface TripMiniTable {
  ...
  note?: string;
  /** true면 가로 스크롤 없이 컬럼을 화면 폭에 맞춰 줄바꿈 */
  compact?: boolean;
  /** true면 '여행의 흐름' 섹션 바로 아래에 렌더링 */
  afterFlow?: boolean;
  /** 출처·근거 스크린샷 (선택) — 클릭 시 확대 */
...
export interface TripDetail {
  ...
  /** 이벤트 소구역별 사진 — section 라벨을 열쇠로 매핑 (선택) */
  eventSectionPhotos?: Record<string, TripGalleryImage[]>;
  /** true면 여행의 흐름을 도입부 자리로 올리고, 도입부는 그 자리로 내려요 (휴무 안내는 흐름 안에 포함) */
  flowFirst?: boolean;
...
export const tripOptions: TripOption[] = [
  {
    ...
    detail: {
      ...
      guides: [
        ...
        {
          title: "📅 확정 일정표 — 12/18~27 로맨틱 가도 렌터카 10일 (앱 '일정'에서 옮겨옴)",
          intro:
            "우리집이 싱가포르 크루즈로 갈라지면서 앱의 일정·지도에 있던 독일 플랜을 이 카드로 옮겨 보관해요. 프랑크푸르트 IN → 뮌헨 OUT, 렌터카로 하이델베르크·로텐부르크·뉘른베르크를 거쳐 뮌헨에서 크리스마스를 보내는 루트예요. 원래 두 가족 6인 기준이라 차량·객실·식당 인원은 3인으로 다시 잡고, 예약 문구는 '권장'으로 바꿨어요.",
          steps: [
            {
              heading: "DAY 1 · 12/18 (금) 프랑크푸르트 ✈️",
              body: "인천 13:05 → 프랑크푸르트 17:20 (LH713 직항). 공항 렌터카 픽업(국제운전면허증 + 한국면허증, 카시트 설치 확인, 윈터 타이어 장착 여부 확인) → 시내 호텔 체크인(모벤픽 프랑크푸르트 시티 추천, 지하 주차 1박 €35) → 20시 뢰머베르크 크리스마스 마켓 가볍게(12/22까지 · 17시 이후 점등). 맛집: Apfelwein Wagner(슈니첼), 마켓 노점 브라트부어스트. 장거리 비행 직후라 21시 전 숙소 복귀 목표.",
            },
            {
              heading: "DAY 2 · 12/19 (토) 하이델베르크 🏰",
              body: "A5 고속도로 90km · 1시간 10분(아침 서리 — 성에 제거 10분 확보). 하이델베르크 성은 푸니쿨라 왕복 포함 티켓을 온라인으로 미리(대형 와인통 필수), 점심 Schnitzelbank(예약 권장), 오후 카를 테오도르 다리·철학자의 길(유모차 가능 코스), 17시 크리스마스 마켓(카를스플라츠 아이스링크). 주차 P12 Kornmarkt(구시가 도보 3분, 시간당 €2.5). 숙소: 슈타이겐베르거 유럽피셔 호프. 카페 Knösel의 '학생 키스' 초콜릿.",
            },
            {
              heading: "DAY 3 · 12/20 (일) 로텐부르크 🎁",
              body: "로맨틱 가도 국도 170km · 2시간(왕복 1차선, 눈 쌓일 수 있음 — 체인 포함 여부 확인). 성벽 밖 P5 주차(1일 €10) 후 호텔에 짐(구시가 호텔은 체크인 시간에만 차량 진입 — 도착 시간 미리 알리기). 마르크트 광장 점심 → 케테 볼파르트 크리스마스 빌리지(오너먼트 쇼핑, 부피 큰 건 마지막 날) → 성벽 걷기·플뢴라인 → 17:30 라이터레스마르크트(슈네발렌 간식). 숙소: 호텔 아이젠후트(구시가). 맛집: Zur Höll(중세 와인 선술집), Brot & Zeit(아침 베이커리).",
            },
            {
              heading: "DAY 4 · 12/21 (월) 뉘른베르크 🌭",
              body: "80km · 1시간. 시내 진입 환경존(Umweltzone) — 렌터카 그린 스티커 확인. 호텔 체크인(르 메르디앙 그랜드, 발렛 1박 €29 또는 Hauptmarkt 지하주차) → 점심 Bratwursthäusle(원조 뉘른베르크 소시지) → 카이저부르크 성(성벽 전경) → 17시 크리스킨들레스마르크트(세계 3대 마켓 · 어린이 마켓 Kinderweihnacht 회전목마 · 2층 마차 투어). 레브쿠헨 본고장 — Lebkuchen Schmidt 본점 틴케이스 선물. Albrecht Dürer Stube는 예약 필요.",
            },
            {
              heading: "DAY 5 · 12/22 (화) 뉘른베르크 2일차 🚂",
              body: "차량 미사용일(지하주차장 배터리만 확인). DB 철도 박물관(기차 좋아하는 아이 천국) → 점심 후 호텔 낮잠 → 장난감 박물관(Spielzeugmuseum) → 17시 마켓 2일차(수공예품 존 · 프라우엔 교회 시계 인형극 · 글뤼바인 컵 보증금 €4). 마켓 마지막 주간이라 저녁 매우 혼잡 — 어린이 마켓은 16시 이전. 맛집: Hausbrauerei Altstadthof(슈바인스학세), Café Bar Wanderer.",
            },
            {
              heading: "DAY 6 · 12/23 (수) 뮌헨 🍺",
              body: "A9 170km · 1시간 50분(공사 구간 — 내비 우회, 눈 예보 시 국도 고려, 시내 환경존 확인). 호텔 바이에리셔 호프 4박(발렛 €45/박) → 마리엔 광장·신시청사(글로켄슈필 11시/12시) → 빅투알리엔 시장 → 17시 마리엔플라츠 크리스마스 마켓(12/24 낮까지만 운영 — 사실상 마지막 기회) → 저녁 호프브로이하우스(예약 권장). ⚠️ 12/24부터 상점·마켓 대부분 휴무 — 쇼핑·장보기(간식·물·아침거리)는 오늘까지.",
            },
            {
              heading: "DAY 7 · 12/24 (목) 뮌헨 · 크리스마스 이브 🎅",
              body: "잉글리시 가든 산책(눈 오면 눈사람) → 12시 마지막 마켓(14시경 종료, 오전 마지막 글뤼바인) → 호텔 휴식·선물 준비 → 18시 이브 디너(호텔 레스토랑 예약 권장, 스마트 캐주얼) → 숙소에서 선물 파티. 12/24 저녁~12/25는 거의 모든 식당·상점 휴무. 아침은 Rischart 베이커리 슈톨렌.",
            },
            {
              heading: "DAY 8 · 12/25 (금) 퓌센 · 노이슈반슈타인 🏔️",
              body: "렌터카 왕복 260km(편도 1시간 50분). 크리스마스 아침 도로 한산 · 주유소 대부분 휴무 — 전날 주유, 고속도로 휴게소 이용. 성은 12/25 개장(12/24·31 휴무) — 온라인 예매 10:30 입장 권장, 마차·셔틀버스로 오르기(아이 체력), 내부 투어 35분, 마리엔 다리는 겨울 폐쇄 여부 현장 확인. 점심 슈방가우 마을(Schlossbrauhaus) → 호엔슈방가우 성 외관·알프 호수(Alpenrose am See) → 16:30 복귀. 주차 P4 호엔슈방가우 €8/일. 알프스 자락 눈길 — 서행.",
            },
            {
              heading: "DAY 9 · 12/26 (토) 뮌헨 🖼️",
              body: "공휴일(성 슈테판의 날)이지만 박물관 개장. 독일 박물관(Deutsches Museum) 어린이 왕국 Kinderreich → 점심 → 님펜부르크 궁전 또는 BMW 벨트 중 택1 → 저녁·짐 정리. Tollwood 겨울 축제가 12/26부터 재개. 맛집: Wirtshaus in der Au(슈바인스브라텐). 내일 반납 전 주유소 위치 확인(공항 근처 Shell).",
            },
            {
              heading: "DAY 10 · 12/27 (일) 뮌헨 → 인천 🛫",
              body: "08시 체크아웃 → 공항 40분 + 주유 15분 → 09:30 공항점 렌터카 반납(풀탱크, 연료 게이지 + 외관 4면 사진, 보증금 홀드 해제 2주) → 체크인 & 택스 리펀(세관 도장 → 환급 카운터 순서 · 위탁수하물에 넣을 물건은 도장 후 부치기) → 12:30 LH718 → 인천 익일 07:55. 새벽 도로 결빙 가능 — 여유 있게 출발. Airbräu(공항 브루어리).",
            },
          ],
          links: [
            {
              label: "노이슈반슈타인 성 공식 예매 (Ticketcenter Hohenschwangau)",
              url: "https://www.hohenschwangau.de/",
            },
            {
              label: "네이버 블로그 — 로맨틱 가도 렌터카 아이랑 후기",
              url: naverBlogSearch("독일 로맨틱 가도 렌터카 크리스마스 마켓 아이랑 후기"),
            },
          ],
          note: "겨울 운전 공통: 독일은 겨울 타이어 법적 의무(픽업 시 확인), 국제운전면허증 + 한국면허증 지참, 시내 환경존(Umweltzone) 그린 스티커, 12/24 오후~12/26 상점·주유소 대부분 휴무 — 장보기·주유는 12/23까지.",
        },
      ],
      gallery: [
        {
  ...
  },
  {
    ...
    title: "싱가포르 + 디즈니 크루즈",
    emoji: "🚢",
    badge: "✅ 크루즈 완납 · 항공 진행 중",
    subtitle: "디즈니 어드벤처 4박 크리스마스 항차 (12/24 출항) + 싱가포르 전후 1박",
    image:
    ...
    imageAlt: "디즈니 크루즈 선박",
    period: "12/23 – 12/29 · 6박 7일 (크루즈 4박 확정)",
    costUnit: "4인",
    costPerFamily: "약 1,300만원",
    costGroup: "성인 2 + 아이 2 (만 6·2세) · 4인 총액",
    costNote:
      "크루즈 완납 $6,260.24 (≈877만 · 15562 바다 베란다 4인·세금 포함, 잔금까지 결제 완료) + 항공 ~330만(대한항공 — 귀국 4명 구매 완료·출국 대기 예약, 실비 확정 전 추정) + 호텔 2박 ~60만 + 식비·교통 ~60만",
    flight: "대한항공 직항 6시간 30분 · 시차 1시간",
    weather: "27~31°C · 덥고 습함, 스콜성 소나기",
    kidScore: 5,
    kidNote:
      "만 6세는 오셔니어 클럽, 만 2세는 너서리 — 둘 다 갈 곳이 있고 캐릭터 그리팅은 가족 단위. 이 연령대에 사실상 최적",
    highlights: [
    ...
    cons: [
      "크리스마스 항차 프리미엄 — 4박 베란다 $6,260 (12월 초 대비 +50% 수준)",
      "배멀미 가능성 (잔잔한 항로이긴 함)",
      "싱가포르 시내 물가 높음",
    ],
    links: [
    ...
    detail: {
      checklist: [
        { label: "크루즈 예약 — 12/24 항차 · 15562 베란다 (06B · 15층 선미)", done: true },
        { label: "크루즈 잔금 완납 — Stateroom Paid", done: true },
        { label: "다이닝 5:45 웨이트리스트 요청 (현재 8:15 배정)", done: true },
        { label: "귀국 항공 KE644 12/29 밤 — 4명 구매 완료", done: true },
        { label: "출국 항공 KE643 12/23 — 4명 대기 예약 → 좌석 확정 시 결제" },
        { label: "다이닝 5:45 확정 여부 — 앱에서 수시 확인" },
        { label: "호텔 12/23·28 — 같은 호텔, 무료취소" },
        { label: "10/10 액티비티 예약 오픈 — 비비디·너서리 등" },
        { label: "너서리(it's a small world) 사전 예약 — 둘째 만 2세라 오셔니어 클럽 불가" },
        { label: "여행자보험 — 4인 · 12/23~12/30 · 의료비 1억 + 구조송환 특약 (VPP 거절 완료)" },
        { label: "원더랜드 날짜 지정 예매 (12/28 저녁)" },
        { label: "11/24 온라인 체크인 오픈 + 승선 시간 선택 · SG 입국카드" },
      ],
      intro:
        "마리나베이 크루즈 센터에서 디즈니 어드벤처에 오르는 순간, 여행 준비가 끝나요. 이동도, 식당 검색도, '오늘 뭐 하지'도 없어요. 아이들은 연령별 키즈클럽으로, 어른은 선베드로. 저녁엔 온 가족이 브로드웨이급 공연을 보고, 복도에서 미키를 만나면 그날은 성공한 날이에요. 디즈니 어드벤처는 2025년 12월 싱가포르에서 취항한 아시아 최초의 디즈니 크루즈로, 중간 기항 없이 바다 위에서만 보내는 '크루즈 투 노웨어' 항로예요 — 하선·재승선 절차가 없으니 아이들을 데리고도 온전히 쉬는 일정이 됩니다. 배 안은 디즈니·마블·픽사 테마 구역으로 나뉘어 있어서, 4박 내내 '오늘은 어느 동네에서 놀까'를 고르는 재미가 있어요. 그리고 — 예약 끝났어요! 🎉 12/24 출항 크리스마스 항차 4박, 15층 선미 바다 베란다 15562(스파이더맨 테마)로 확정하고 잔금까지 완납했어요. 귀국편 대한항공(12/29 밤 비행)도 4명 구매 완료, 가는 편(12/23)은 대기 예약 중. 크리스마스 이브와 당일을 바다 위에서, 디즈니 캐릭터들과 보내는 여행이 진짜가 됐습니다. 이제 남은 숙제는 가는 편 좌석 확정·호텔·다이닝 얼리 확정, 그리고 10/10 액티비티 예약 오픈 — 아래 체크리스트를 순서대로 처리하면 돼요.",
      flowFirst: true,
      notice: {
        title: "12월 싱가포르 — 휴무 걱정은 없어요",
        items: [
          "12/25는 공휴일이지만 관광지·몰·레스토랑 모두 정상 영업 — 독일과 정반대예요.",
          "12월 말은 연말 최성수기 — 시내 호텔이 빨리 마르니 12/23·28 숙박부터 무료취소로 확보하세요.",
        ...
        "🚢 크루즈 선상 — 홀리데이 항차 프로그램": [
          {
            ...
            alt: "항해 중인 디즈니 크루즈",
            caption: "항해 중인 디즈니 어드벤처 — 배가 곧 목적지",
          },
          {
            src: "https://images.unsplash.com/photo-1579467299604-55d903a6d06e?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGlzbmV5JTIwY3J1aXNlJTIwc2hpcHxlbnwwfHwwfHx8MA%3D%3D",
            alt: "크루즈 갑판 풍경",
            caption: "갑판에서 맞는 바닷바람",
          },
          {
            src: "https://images.unsplash.com/photo-1707342615832-c16737e45925?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8ZGlzbmV5JTIwY3J1aXNlJTIwc2hpcHxlbnwwfHwwfHx8MA%3D%3D",
            alt: "바다 위의 크루즈",
            caption: "수평선뿐인 항해의 풍경",
          },
        ],
        "🌴 싱가포르 시내 — 승선 전후로": [
        {
      ...
      tables: [
        {
          afterFlow: true,
          compact: true,
          title: "🎫 예약 현황 — 2026-09-11 기준",
          intro:
            "디즈니 크루즈 My Reservation과 대한항공 앱에서 확인한 실제 상태예요. 예약번호·탑승객 이름은 공개 페이지라 적지 않았어요 — DCL 확인 메일과 각 앱에서 관리해요.",
          columns: ["내용", "상태"],
          rows: [
            {
              label: "크루즈",
              cells: [
                "디즈니 어드벤처 4박 · 12/24(목) 승선 ~ 12/28(월) 하선 · 4명",
                "✅ 완납 (Stateroom Paid)",
              ],
            },
            {
              label: "객실",
              cells: [
                "15562 · Deluxe Oceanview with Verandah · 카테고리 06B · 15층 · 선미(Aft)",
                "✅ 확정",
              ],
            },
            {
              label: "다이닝",
              cells: ["배정 8:15 PM (±15분) · 5:45 PM 웨이트리스트 요청 접수", "🕐 확정 대기"],
            },
            {
              label: "보험",
              cells: ["디즈니 VPP 어른 2명 모두 거절 처리 → 국내 여행자보험 (아래 비교표)", "⬜ 카카오페이 4인 예정"],
            },
            {
              label: "항공 귀국",
              cells: [
                "대한항공 KE644 · 12/29(화) 22:30 → 인천 12/30 05:45 · 4명 (2명씩 2건)",
                "✅ 구매 완료",
              ],
            },
            {
              label: "항공 출국",
              cells: [
                "대한항공 KE643 · 12/23(수) 14:35 → 싱가포르 20:25 · 4명 (2명씩 2건)",
                "🕐 대기 예약",
              ],
            },
            {
              label: "다음 오픈",
              cells: [
                "10/10 액티비티 예약 창 · 11/24 온라인 체크인(승선 시간 선택)",
                "⬜ 캘린더 알림",
              ],
            },
          ],
          note: "액티비티 예약 창은 '완납 후'에만 열려요 — 완납이 끝났으니 10/10에 바로 예약 가능. 온라인 체크인은 11/24부터, 미국 시간 기준 오픈이니 스위티 팁의 오픈 시각 후기를 참고하세요.",
        },
        {
          afterFlow: true,
          title: "🏨 앞뒤 1박 호텔 비교 — 12/23·12/28 시내권 4파전",
          intro:
            "두 밤을 같은 호텔로 잡는 게 기본 전략이에요 (짐 보관·재체크인이 빨라지고, 예약 메모에 '크루즈 전후 재방문'을 남기면 얼리 체크인 배려도 기대). 어른 2 + 아이 2 기준 비교예요.",
          columns: [
            "✅ 스위소텔 더 스탬포드",
            "콘래드 센테니얼",
            "마리나베이 샌즈",
          ...
          rows: [
            ...
            },
            {
              label: "객실·침대",
              cells: [
                "객실이 넓은 편 — 트윈+엑스트라베드 구성이 수월해요",
                "패밀리 구성 가능 + 체크인 때 아이들에게 테디베어·러버덕 증정",
                "킹+롤어웨이 — 4인이면 비용이 급등해요",
                "패밀리룸 구성이 좋은 편",
              ],
            },
            {
              label: "수영장·아이",
              cells: [
                "야외 풀 2개 — 하선일 오후 물놀이 딱",
                "야외 풀 + 키즈 어메니티",
                "그 유명한 인피니티풀 (투숙객 전용, 아이 동반 가능)",
                "스위소텔과 풀·몰 인프라 공유",
              ],
            },
            {
              label: "위치·터미널",
              cells: [
                "시티홀 MRT·쇼핑몰 직결 · 터미널 ~10분 — 스콜 와도 실내 동선",
                "선텍시티 몰 직결 · 터미널 ~10분",
                "가든스·원더랜드 도보 · 터미널 ~5분 (최근접)",
                "시티홀 직결 · 터미널 ~10분",
              ],
            },
            {
              label: "이런 경우 선택",
              cells: [
                "고민하기 싫으면 이거 — 두 밤 모두 여기 (1순위)",
                "체크인 순간 아이들 환호가 중요하면",
                "12/28 하루만 '마지막 밤 이벤트'로 쪼개서",
                "스위소텔이 만실이거나 조금 더 조용한 쪽을 원하면",
              ],
            },
          ],
          note: "가격은 연말 최성수기 추정(아고다 기준, 시점 따라 크게 변동). 전략: 스위소텔 두 밤을 무료취소로 먼저 걸어두고 → 마음이 바뀌거나 MBS 특가가 뜨면 갈아타기. 연말엔 호텔이 항공보다 먼저 마르니 오늘 걸어두는 게 1순위예요.",
        },
        {
          afterFlow: true,
          title: "✈️ 항공편 비교 — 12/23 도착 · 12/29 귀국 (직항)",
          intro:
            "✅ 대한항공으로 결정 — 귀국 KE644는 4명 구매 완료, 가는 편 KE643은 4명 대기 예약 중이에요. 아래 표는 결정 당시 비교표(참고용). 가격은 연말 성수기 왕복 추정치(어른 1인) — 소아(만 2~11)는 FSC 기준 어른의 약 75%예요.",
          columns: [
            "✅ 대한항공 (KE)",
            "싱가포르항공 (SQ)",
            "티웨이항공 (TW)",
          ...
          rows: [
            {
              label: "12/23 가는 편",
              cells: [
                "🕐 KE643 14:35→20:25 — 4명 대기 예약 중 (2명씩 2건). 좌석 확정 알림 오면 즉시 결제. 플랜 B는 전날 밤 KE647 23:10→새벽 도착",
                "SQ607 08:50→14:25 ⭐ 오후 2시 반 도착 — 그날 저녁 원더랜드까지 가능한 유일한 오전 출발",
                "TW 15:30→21:25 — 저녁 도착, 첫날은 체크인만",
                "스쿠트 TR843 11:30→17:00 (주 3회 — 12/23 운항 여부 확인 필수)",
              ],
            },
            {
              label: "12/29 오는 편",
              cells: [
                "✅ KE644 22:30→익일 05:45 — 4명 구매 완료 (2명씩 2건). 계획 그대로 '밤 비행', 주얼 창이 후 저녁 출발",
                "SQ606 14:35→22:00 (낮 비행, 12/29 밤 귀가) 또는 SQ608 00:10 심야",
                "TW164 02:15→09:50 — ⚠️ 티켓 날짜가 12/30 새벽으로 찍혀요",
                "TR842 02:15→09:45 — 동일하게 12/30 새벽 표시",
              ],
            },
            {
              label: "왕복 추정 (어른 1인)",
            ...
            {
              label: "4인 총액 추정",
              cells: ["약 320~420만", "약 280~380만", "약 180~260만", "약 150~230만"],
            },
            {
              label: "수하물·좌석",
              cells: [
                "위탁 23kg 포함 · 4인 나란히 좌석 무료 지정 · 마일리지 적립",
                "위탁 포함 · 기내 서비스 최상급 (아이 밀·놀이키트)",
                "A330 대형기 — 운임에 따라 수하물 포함/불포함 확인",
                "수하물·좌석지정·기내식 전부 유료 — 크루즈 짐(캐리어 4개+문꾸미기)이면 추가비가 확 붙어요",
              ],
            },
            {
              label: "아이 둘과 포인트",
              cells: [
                "밤 비행 귀국의 정석 — 이륙과 함께 취침, 아침 인천 도착",
                "가는 편 최강 — 오전 출발이라 아이들 컨디션으로 비행, 도착 후 반나절 활용",
                "가격 대비 대형기 — 심야 출발 귀국은 새벽 2시 공항 대기가 관건",
                "최저가지만 부가비+심야 대기 감안하면 가족 여행 이점이 줄어요",
              ],
            },
          ],
          note: "결정: 대한항공 왕복 (마일리지·4인 나란히 좌석·위탁수하물 포함). 남은 일은 가는 편 KE643 대기 확정 — 확정이 안 되면 전날 밤 KE647(12/22 23:10 출발·12/23 새벽 도착)이나 SQ607(08:50→14:25)로 갈아타는 게 플랜 B예요. 시간표는 시즌마다 바뀌니 발권 전 재확인.",
        },
        {
          title: "💰 우리 항차 요금 — 🎄 12/24–28 크리스마스 4박 (4인 총액 · 세금 포함)",
          intro:
            "예약 완료한 12/24(목) 출발 크리스마스 항차의 공식 조회가예요. 우리는 바다 베란다급(06B Deluxe Oceanview with Verandah)으로 $6,260.24에 확정하고 완납까지 마쳤어요.",
          compact: true,
          columns: ["인사이드", "오션뷰", "✅ 우리 등급 (06B)", "컨시어지"],
          rows: [
            {
              label: "🎄 12/24–28 (목)",
              cells: [
                "$3,763 (~527만)",
                "$4,923 (~689만)",
                "$6,260.24 (~877만) · 15562 완납 ✅",
                "매진",
              ],
            },
          ],
          note: "크리스마스 항차는 12월 초 항차 대비 +50% 수준의 프리미엄이지만, 크리스마스 이브·당일을 배에서 보내는 유일한 4박이라 컨시어지부터 매진된 인기 항차였어요 — 예약 완료로 확보 성공! (환산 1,400원/USD 기준)",
          photos: [
            {
              src: "/sweety/fare-4night.jpg",
              alt: "공식 사이트 4박 항차 요금 화면",
              caption: "원본 스크린샷 — 예약 당시 4박 항차 요금 (표의 출처)",
            },
          ],
        },
        {
          title: "🧮 실제 결제 현황 & 남은 비용",
          intro:
            "크루즈 완납 + 귀국 항공 구매 완료 기준으로, 확정된 금액과 앞으로 나갈 돈을 정리했어요.",
          columns: ["항목", "금액", "비고"],
          rows: [
            {
              label: "1 · 크루즈 (완납 ✅)",
              cells: [
                "$6,260.24",
                "예약금 $606.04 + 잔금 $5,654.20 전액 결제 완료",
                "My Reservation에 'Stateroom Paid' 표시 — 더 낼 크루즈 요금 없음. 완납 덕에 10/10 액티비티 예약도 바로 가능",
              ],
            },
            {
              label: "2 · 팁 (자동 부과)",
            ...
            },
            {
              label: "3 · 선내 불포함 항목",
              cells: [
                "주류·스페셜티 식당·와이파이·사진·너서리",
                "선택",
                "식사·공연·키즈클럽·수영장·워터슬라이드는 전부 포함",
              ],
            },
            {
              label: "4 · 배 바깥 비용 (진행 중)",
              cells: [
                "항공 + 호텔 2박 + 시내 식비·교통",
                "약 420~480만원 추정",
                "항공 ~330만(대한항공 — 귀국 4명 구매 완료·출국 대기 예약, 확정되면 실비로 교체) + 호텔 12/23·28 ~60만 + 식비·교통 ~60만",
              ],
            },
            {
              label: "= 4인 총 예상",
              cells: [
                "약 1,300만원",
                "—",
                "크루즈 확정 877만 + 팁 36만 + 배 바깥 420~480만",
              ],
            },
          ],
          note: "다음 순서: ① 가는 편 KE643 대기 확정 → 결제 ② 호텔 무료취소 예약 (돈 안 나감) ③ 10/10 액티비티 예약 오픈 ④ 11/24 온라인 체크인. 크루즈 잔금은 끝났고, 여행자보험은 출발 전 아무 때나.",
        },
        {
          title: "🛡️ 여행자보험 비교 — 크루즈 4인 7일 기준 (12/23~12/30)",
          intro:
            "디즈니 VPP는 거절했으니 국내 해외여행보험으로 커버해요. 크루즈라서 다른 점 세 가지: ① 선내 의무실은 보험 직접 결제가 안 되고 객실 계정에 청구돼요(하선 시 정산 → 귀국 후 청구, 상세 청구서+진단서 필수) ② 해상 긴급 이송(헬기·에어앰뷸런스)은 '중대사고 구조송환비용' 특약에 들어 있어요 — 꼭 선택 ③ 국내 상품은 여행 취소(크루즈 요금 $6,260)를 사실상 못 막아요. 귀국편이 12/30 새벽 도착이라 보험 종료일은 12/30로.",
          columns: [
            "✅ 카카오페이손보",
            "삼성화재 다이렉트 · 토스",
            "현대해상 다이렉트",
          ...
          rows: [
            ...
            },
            {
              label: "아이·가족 가입",
              cells: [
                "동반 만 0세부터 최대 10명, 대표자(엄마) 한 번 가입 — 만 2세 둘째도 OK",
                "가족형 10% 할인(2인 이상), 미성년자는 자녀만 동반 · 토스는 삼성 단체보험",
                "만 12세 이하 자녀 할인(다자녀는 최저 연령 기준)",
                "가족·단체 다이렉트 가입 가능 · 실손 있으면 국내치료 담보 제외해 절약",
                "카드 명의자(+배우자·자녀 일부)만 · 카드사별 조건 확인",
              ],
            },
            {
              label: "의료비 한도",
              cells: [
                "상해·질병 각 최대 1억 (2025.12 상향) · 플러스 패키지 선택",
                "플랜별 선택 — 한도 올려도 보험료 차이 수천 원",
                "플랜별 선택 · 구조송환비용 특약 약관 포함",
                "플랜별 선택 · 저가 플랜은 한도 낮음 — 1억으로 올릴 것",
                "의료비 없거나 소액 — 사망·후유장해 위주",
              ],
            },
            {
              label: "크루즈 포인트",
              cells: [
                "24시간 알람센터 · 의료비 지불보증 · 의료통역 · 의료이송 포함",
                "24시간 우리말 서비스(+82-2-3140-1777) · 다이렉트 앱 청구",
                "24시간 우리말 상담(+82-2-2628-2080) · 알림톡 청구",
                "항공·선박 지연 시 보장 종기 24시간 자동 연장(DB)",
                "선내 진료비 커버 기대 금물",
              ],
            },
            {
              label: "항공 지연·취소",
              cells: [
                "항공기 지연 실손형(체류비 영수증) · 여행 취소 없음",
                "2시간+ 지연 정액(지수형, 국내·해외 출발) · 여행취소 위약금은 365 연간형만(최대 100만·80%)",
                "출국편 2시간+ 지연 시 4~10만원 정액 · 여행 취소 없음",
                "지연 특약 상품별 상이 · 여행 취소 없음",
                "없음",
              ],
            },
            {
              label: "4인 7일 보험료 (추정)",
              cells: [
                "약 3~5만원 → 무사고 10% 환급(최대 3만원)",
                "약 3~5만원 (가족형 10% 할인 후) · 토스는 +10% 포인트",
                "약 3~5만원 (자녀 할인 후)",
                "약 2.5~4만원",
                "0원",
              ],
            },
            {
              label: "이런 경우 선택",
              cells: [
                "고민하기 싫으면 이거 — 넷이 한 번에, 카톡으로 청구 (1순위)",
                "KE643 대기·연말 지연 리스크를 정액으로 보상받고 싶으면",
                "아이 둘 할인 + 정액 지연 보상 둘 다 원하면",
                "최저가로 의료비만 확실히 챙기면 되면",
                "가입 후 '추가로' 있는지 확인하는 용도",
              ],
            },
          ],
          note: "보험료는 동남아 7일 표준형 기준 추정(성인 1인 7일 평균 9천 원대, 아이는 더 저렴) — 정확한 금액은 보험다모아나 각 다이렉트 화면에 생년월일·기간(12/23~12/30)을 넣어 2~3곳 견적 비교. 선내 의무실 실제 사례: 아이 중이염 진료+항생제 $200 미만, 손 골절 $400, 인두염 $250 — 하선 정산 후 귀국해서 청구해요. 카드 무료보험은 항공권을 그 카드로 결제했을 때만 붙고 의료비는 거의 없어요.",
        },
        {
          title: "🛏️ 객실 테마 맵 — 우리 방은 🕷️ 스파이더맨 (15562)",
          intro:
            "룸테마 시트(객실 번호별 전수 데이터) 집계예요. 우리가 확정한 15562는 15층 선미(Aft) 06B 베란다, 스파이더맨 테마 — 남아 둘 취향 저격으로 골랐어요. 아래는 배 전체 분포 참고용.",
          columns: ["테마", "객실 수", "주로 있는 곳"],
          rows: [
            {
              label: "겨울왕국",
              cells: ["FROZEN", "424실", "9~16층 전반 — 인사이드 7A·9A·11A는 전부 겨울왕국"],
            },
            {
              label: "인어공주",
              cells: ["LITTLE MERMAID", "490실", "12~13층 집중"],
            },
            {
              label: "라이온킹",
              cells: ["LION KING", "397실", "10~11층"],
            },
            {
              label: "스파이더맨",
              cells: ["SPIDERMAN", "302실", "15~16층"],
            },
            {
              label: "니모 · 업 · 아이언맨 · 토르",
              cells: [
                "FINDING NEMO / UP / IRONMAN / THOR",
                "각 80~112실",
                "니모 12~13층 · 업 10~11층 · 아이언맨 15층 · 토르 16층(04 카테고리)",
              ],
            },
            {
              label: "희귀 테마",
              cells: [
                "MOANA 9실 · ALADDIN 35실 · ENCANTO 49실",
                "—",
                "모아나는 03A·03B 베란다에만! 알라딘·자스민은 17~18층",
              ],
            },
            {
              label: "스위트",
              cells: ["ELSA / ANNA SUITE", "각 2실", "18층 최상위 카테고리 (01A·02A)"],
            },
          ],
          note: "오션뷰(06 카테고리)는 겨울왕국·라이온킹·인어공주·스파이더맨 중 하나 — 배정 층으로 유추 가능해요 (10~11층이면 라이온킹, 12~13층 인어공주, 15~16층 스파이더맨 확률).",
        },
      ],
      flow: [
        {
          heading: "🌴 DAY 1 (12/23 수) · 도착 — 시내권 1박",
          body: "대한항공 KE643(14:35 출발 → 20:25 도착, 대기 예약 중) 기준 저녁 도착이에요. 입국·택시까지 하면 호텔 도착은 밤 10시 전후 — 첫날은 시내권(마리나베이·시티홀) 호텔 체크인과 짐 풀기, 컨디션이 되면 마리나베이 야경 산책까지가 현실적이에요. 주얼 창이 폭포와 크리스마스 원더랜드는 12/28~29로 넘겨요(원더랜드는 1/1까지·날짜 지정 예매). 호텔은 아래 비교표에서.",
        },
        {
          heading: "🚢 DAY 2 (12/24 목) · 승선 — 크리스마스 이브 출항",
          body: "오전엔 머라이언 파크·마리나베이 산책, 정오 전에 터미널행 택시 5~10분. 체크인은 오전에 일찍 할수록 유리해요 — 점심부터 선내 뷔페와 수영장을 쓸 수 있으니 수영복은 캐리온 가방에! 승선하자마자 디즈니 크루즈 앱으로 캐릭터 그리팅과 공연 예약이 첫 미션. 크리스마스 이브 밤, 출항과 함께 트리 점등식으로 홀리데이 항차가 시작돼요.",
        },
        {
          heading: "🚢 DAY 2–6 (12/24~28) · 크리스마스 항차 4박 ✅",
          body: "크리스마스 당일을 바다 위에서! 우리 방은 15층 선미 바다 베란다 15562(06B · 스파이더맨 테마), 잔금까지 완납 ✅ — 아침마다 발코니에서 항적과 수평선을 보며 시작해요. 낮엔 워터슬라이드와 수영장, 저녁엔 매일 다른 테마 레스토랑을 도는 로테이션 다이닝(현재 8:15 배정 · 5:45 얼리 웨이트리스트 요청 중) — 서버가 같이 이동하며 아이들 취향을 기억해줘요. 아이들이 연령별 키즈클럽에 있는 동안 어른은 성인 전용 구역에서 진짜 휴가를 보내고, 밤엔 온 가족이 디즈니·마블 쇼와 산타 그리팅. 식사·공연·키즈클럽 전부 요금 포함이에요.",
        },
        {
          heading: "🌴 DAY 6 (12/28 월) · 하선 — 같은 호텔 재체크인",
          body: "오전 하선 → 12/23에 묵었던 시내권 호텔로 (택시 5~10분). 짐 맡기고 얼리 체크인 요청 — 크루즈 직후의 아이들은 이미 '풀충전' 상태라 낮엔 호텔 풀과 낮잠으로 가볍게. 저녁은 원더랜드 마지막 기회 또는 스펙트라 분수쇼로 마무리해요.",
        },
        {
          heading: "✈️ DAY 7 (12/29 화) · 귀국 — 주얼 창이 피날레",
          body: "귀국편은 대한항공 KE644 22:30 출발 → 인천 12/30 05:45 도착으로 4명 구매 완료 ✅. 레이트 체크아웃 요청 후 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 폭포와 캐노피 파크 미끄럼틀·미로가 아이들 마지막 코스. 밤 비행이라 이륙과 함께 잠들고, 12/31 카운트다운 인파 전에 빠져나오는 일정이라 혼잡 걱정도 없어요.",
        },
      ],
      kids: "이 배는 사실상 만 6세와 만 2세를 위해 설계됐어요. 첫째는 오셔니어 클럽(3~10세), 둘째는 너서리 it's a small world — 각자 레벨에 맞게 놀고, 부모는 몇 시간이나마 '여행 중 휴가'를 얻어요. 캐릭터 그리팅은 가족 단위 촬영이라 대기도 짧은 편. 배가 곧 목적지라 '오늘은 어디 가야 해서 일찍 일어나'가 없다는 것도 아이들에겐 큰 장점 — 낮잠 리듬을 지키면서도 하루가 꽉 차요. 유아 동반 가족을 위한 너서리(영유아 돌봄), 유아풀, 가족 전용 프로그램이 따로 있어서 3세도 소외되지 않아요.",
      tips: [
        "🧳 수영복·래시가드는 캐리온 가방에 — 승선 직후 짐이 객실에 오기 전 수영장 직행",
        "🧳 여권 (유효기간 6개월+) · 크루즈 서류 · 카드 — 여권 스펠링은 예약과 일치 확인",
        "🧳 뱃멀미약 (어린이용 포함) + 아이 상비약·해열제 — 선내 의무실은 비싸요",
        "🧳 문꾸미기 자석 + 아이들 홀리데이 의상 — 크리스마스 항차는 캐릭터도 산타 의상",
        "🧳 얇은 긴팔 — 선내 에어컨이 강해요 (공연장·레스토랑)",
        "🧳 12/25 산타 선물 — 한국에서 미리 포장해 가면 크리스마스 아침이 완성돼요",
        "📱 디즈니 크루즈 앱 설치 — 승선 즉시 공연·캐릭터 그리팅 예약이 첫 미션",
        "🏊 승선일 오전 체크인 — 점심부터 선내 뷔페·수영장 이용 가능",
        "📅 캘린더 알림 3개 — 10/10 액티비티 오픈 · 11/24 온라인 체크인 오픈 · KE643 대기 확정 알림",
      ],
      booking: {
        title: "✅ 크루즈 완납 · 항공 반쪽 확정 — 남은 체크리스트",
        intro:
          "12/24 크리스마스 항차 4박, 15562 바다 베란다(06B · 15층 선미)로 공식 사이트 직예약 + 잔금까지 완납 (4인 $6,260.24 · Stateroom Paid). 항공은 대한항공으로 — 귀국 KE644(12/29 밤)는 4명 구매 완료, 가는 편 KE643(12/23)은 4명 대기 예약 중이에요. 이제 아래 순서대로 처리하면 여행 준비 끝이에요.",
        steps: [
          {
            heading: "1 · 가는 편 KE643 대기 확정 — 알림 오면 즉시 결제",
            body: "12/23(수) 14:35→20:25 KE643이 4명 대기 예약(엄마 계정 2명 + 아빠 계정 2명) 상태예요. 대한항공 앱 알림이 오면 두 예약 모두 바로 결제하고, 4인 나란히 좌석 지정까지 끝내세요. 연말까지 확정이 안 되면 플랜 B는 전날 밤 KE647(12/22 23:10 출발·새벽 도착) 또는 SQ607(08:50→14:25) — 12/23 호텔 예약과 같이 움직여야 해요.",
          },
          {
            heading: "2 · 다이닝 — 5:45 웨이트리스트 요청 완료 ✅ · 확정 대기",
            body: "현재 배정은 8:15 PM(±15분), 5:45 PM 요청은 접수돼 있어요(My Reservation에 'Cancel Waitlist Request'가 보이면 정상). 확정되면 Dining 항목이 바뀌니 출항까지 가끔 확인하고, 끝내 안 되면 승선 첫날 다이닝 데스크에서 다시 요청 — 크리스마스 항차라 얼리 경쟁이 치열해요.",
          },
          {
            heading: "3 · 크루즈 잔금 — 완납 ✅ 끝",
            body: "예약금 $606.04 + 잔금 $5,654.20 전액 결제 완료, 'Stateroom Paid' 확인. 더 낼 크루즈 요금은 없고, 선상 팁(1인 1박 $16 · 4박 약 $256)은 승선 후 객실 계정에 자동 부과돼요. 완납 덕에 액티비티 예약 창도 열려요.",
          },
          {
            heading: "4 · 호텔 — 12/23·12/28 같은 호텔로",
            body: "시내권(스위소텔 1순위) 무료취소 요금제로 두 밤 예약 — 예약 메모에 '크루즈 전후 재방문'과 '12/23 밤 10시경 늦은 체크인'을 남기면 얼리 체크인 배려와 노쇼 처리 방지를 같이 챙겨요. 연말 성수기라 호텔이 항공보다 먼저 말라요.",
          },
          {
            heading: "5 · 10/10 액티비티 예약 오픈 — 완납이라 바로 가능",
            body: "My Reservation의 Cruise Activities 창이 10/10에 열려요(완납 예약만 가능). 열리면 My Plans에서 비비디 바비디 부티크(3~12세, 드레스 포함 $230 수준 · 일찍 잡을수록 드레스를 오래 입어요), 너서리 it's a small world(둘째는 2024.5생 만 2세라 오셔니어 클럽 입장 불가 — 너서리가 1순위 예약), 성인 스파, 유료 액티비티를 예약 — 미국 시간 기준 오픈이니 한국시간 오픈 시각을 미리 확인하고 알림을 걸어두세요.",
          },
          {
            heading: "6 · 11/24 온라인 체크인 오픈 & 입국 서류",
            body: "승선 30일 전인 11/24부터 온라인 체크인 — 여권·결제카드 등록, 탑승객 전원 사진, 그리고 승선 시간(Port Arrival Time) 선택이 여기서 이뤄져요. 이른 시간대가 빨리 마르니 오픈 직후가 유리(스위티 팁 참고). Required Citizenship Documents 기준 한국 여권은 유효기간 6개월 이상 확인. 싱가포르 SG Arrival Card는 도착 3일 전부터 온라인 제출.",
          },
          {
            heading: "7 · 여행자보험 — 카카오페이손보 4인 한 번에 (12/23~12/30)",
            body: "디즈니 VPP는 어른 2명 모두 거절 처리됐어요(예약에 Declined 표시). 국내 상품으로 갈 때 크루즈용 체크 5가지: ① 해외 상해·질병 의료비 각 1억(한도 올려도 보험료 차이 수천 원) ② '중대사고 구조송환비용' 특약 선택 — 해상 헬기·에어앰뷸런스 이송 대비 ③ 24시간 우리말 알람센터 + 의료비 지불보증 ④ 선내 의무실은 보험 직접 결제 불가 → 객실 계정 청구 → 하선 정산 → 귀국 후 청구, 상세 청구서(itemized bill)+진단서 꼭 받기 ⑤ 종료일은 귀국편 도착일 12/30로. 여행 취소(크루즈 요금 $6,260)는 국내 상품으론 못 막아요(삼성 365 연간형만 최대 100만) — 출발 전 건강 관리가 유일한 보험. 1순위 카카오페이(동반 만 0세부터 · 무사고 10% 환급 · 카톡 청구), 정액 항공 지연 보상이 끌리면 삼성화재·현대해상 다이렉트. 아래 비교표 참고.",
          },
        ],
        links: [
          {
            label: "디즈니 크루즈 — 내 예약 관리 (My Reservation)",
            url: "https://disneycruise.disney.go.com/",
          },
          {
            label: "대한항공 — 예약 조회·대기 예약 상태 (마이페이지)",
            url: "https://www.koreanair.com/",
          },
          {
            label: "카카오페이손보 — 해외여행보험 (카카오페이 앱 › 보험)",
            url: "https://kakaopayinscorp.co.kr/",
          },
          {
            label: "삼성화재 다이렉트 — 해외여행보험",
            url: "https://direct.samsungfire.com/m/mall/MP030701_001.html",
          },
          {
            label: "현대해상 다이렉트 — 해외여행보험",
            url: "https://direct.hi.co.kr/service.do?m=7435d816d2",
          },
          {
            label: "보험다모아 — 해외여행보험 보험료 비교 (금감원)",
            url: "https://e-insmarket.or.kr/",
          },
          {
            label: "디즈니 크루즈 — 선내 의료시설 안내 (영문 FAQ)",
            url: "https://disneycruise.disney.go.com/faq/health-safety/onboard-medical/",
          },
          {
            label: "SG Arrival Card — 싱가포르 입국 신고 (공식)",
            url: "https://eservices.ica.gov.sg/sgarrivalcard/",
          },
          {
            label: "스위소텔 더 스탬포드 — 아고다 예약",
            url: "https://www.agoda.com/ko-kr/swissotel-the-stamford-hotel/hotel/singapore-sg.html",
          },
          {
            label: "스카이스캐너 — 인천-싱가포르 항공권",
            url: "https://www.skyscanner.co.kr/routes/icn/sins/incheon-international-to-singapore.html",
          },
        ],
        note: "예약번호·탑승객 이름 등 상세 정보는 DCL 확인 메일·앱 My Reservation과 대한항공 마이페이지에서 관리해요(공개 페이지라 여기엔 안 적어요). 참고: 공식 직예약이 국내 여행사 단품보다 우리 가족 구성(3·4번째 인원 할인)에 유리했던 건 실측으로 확인된 사실 — 잘 고른 선택이에요.",
      },
      guides: [
        {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: "저녁은 로테이션 다이닝(6가지 배정 경우의 수, 승선 후 앱 확인) — 5:45/8:15 2부제인데 아이 가족은 5:45가 정석이라 예약 시 바로 선택하세요(늦으면 대기신청 — 우리도 8:15 배정 → 5:45 대기 신청 중). 무료 맛집: 그램마 탈라스 키친(모아나 할머니 컨셉, 한국인 후기 최고), 스티치스 오하나 그릴(고추장 버거·김치 핫도그!), 피자 플래닛(밤 9시 재오픈 직후가 한산). 룸서비스 조식 무료(카드에 체크해 새벽 3시까지 문에, 하선일 제외), 아이스아메리카노는 17층 바샤 커피머신에서. 영어 메뉴판이 걱정이면 첨부된 손글씨 한글 번역본 10쪽이면 끝이에요.",
            },
            {
            ...
            {
              heading: "6 · 우리 아이들(만 6세·만 2세) 시설 매핑",
              body: "오셔니어 클럽(3~10세, 무료·기저귀 졸업 필수)은 첫째만 — 둘째는 만 2세라 너서리 it's a small world(30분 $4.5, 사전 예약)가 정답이에요. 수영장: 스플래시 패드는 4세 이하 전용이고 방수기저귀 아이는 여기만 가능, 플라잉 소서는 4~8세, 슬라이드는 키 122cm 이상. 비비디 바비디 부티크(3~12세, 드레스 포함 $230 수준)는 사전예약 필수 — 일찍 잡을수록 드레스를 며칠 입어요. 남자아이 인기 코스는 마블 스타일 스튜디오.",
            },
            {
          ...
          photos: [
            {
              ...
              alt: "정리본 1쪽",
              caption: "정리본 p.1 — 예약처·용어·온라인 체크인",
            },
            {
              src: "/sweety/tip-02.jpg",
              alt: "정리본 2쪽",
              caption: "정리본 p.2 — 체크인 필수서류·어플·선내 결제",
            },
            {
              src: "/sweety/tip-03.jpg",
              alt: "정리본 3쪽",
              caption: "정리본 p.3 — 팁(봉사료)·성수기·문꾸미기 규칙",
            },
            {
              src: "/sweety/tip-04.jpg",
              alt: "정리본 4쪽",
              caption: "정리본 p.4 — 문꾸미기 DIY·픽시더스트 선물 추천",
            },
            {
              src: "/sweety/tip-05.jpg",
              alt: "정리본 5쪽",
              caption: "정리본 p.5 — 핀 트레이딩 + 객실 종류 ① 인사이드·오션뷰",
            },
            {
              src: "/sweety/tip-06.jpg",
              alt: "정리본 6쪽",
              caption: "정리본 p.6 — 객실 종류 ② 가든뷰 베란다·컨시어지 특전",
            },
            {
              src: "/sweety/tip-07.jpg",
              alt: "정리본 7쪽",
              caption: "정리본 p.7 — 층별 시설 ① 굿즈샵·시어터·비비디 부티크",
            },
            {
              src: "/sweety/tip-08.jpg",
              alt: "정리본 8쪽",
              caption: "정리본 p.8 — 층별 시설 ② 엣지·바이브·D라운지",
            },
            {
              src: "/sweety/tip-09.jpg",
              alt: "정리본 9쪽",
              caption: "정리본 p.9 — 층별 시설 ③ 너서리·수영장 나이 제한·세탁실",
            },
            {
              src: "/sweety/tip-10.jpg",
              alt: "정리본 10쪽",
              caption: "정리본 p.10 — 층별 시설 ④ 토이스토리 워터파크·마블 랜딩",
            },
            {
              src: "/sweety/tip-11.jpg",
              alt: "정리본 11쪽",
              caption: "정리본 p.11 — 저녁 로테이션 다이닝 배정표",
            },
            {
              src: "/sweety/tip-12.jpg",
              alt: "정리본 12쪽",
              caption: "정리본 p.12 — 무료 식당·룸서비스·음료 스테이션",
            },
            {
              src: "/sweety/tip-13.jpg",
              alt: "정리본 13쪽",
              caption: "정리본 p.13 — 주류 패키지·반입 규정·팝콘 버킷",
            },
            {
              src: "/sweety/tip-14.jpg",
              alt: "정리본 14쪽",
              caption: "정리본 p.14 — 공연 일정표 ① 세일어웨이·리멤버·어벤저스",
            },
            {
              src: "/sweety/tip-15.jpg",
              alt: "정리본 15쪽",
              caption: "정리본 p.15 — 공연 일정표 ② 라이온킹 불꽃놀이(우현!)",
            },
            {
              src: "/sweety/tip-16.jpg",
              alt: "정리본 16쪽",
              caption: "정리본 p.16 — 액티비티 사전신청·포토 패키지·포토스팟",
            },
            {
              src: "/sweety/tip-17.jpg",
              alt: "정리본 17쪽",
              caption: "정리본 p.17 — 비비디 예약·공주님 티파티·스파",
            },
            {
              src: "/sweety/tip-18.jpg",
              alt: "정리본 18쪽",
              caption: "정리본 p.18 — 캐릭터 그리팅·로얄 게더링 준비물(다이소 품번)",
            },
            {
              src: "/sweety/tip-19.jpg",
              alt: "정리본 19쪽",
              caption: "정리본 p.19 — 카페 왓츠앱·승선 절차·준비물",
            },
            {
              src: "/sweety/tip-20.jpg",
              alt: "정리본 20쪽",
              caption: "정리본 p.20 — 반입금지 물품·와이파이 요금",
            },
            {
              src: "/sweety/tip-21.jpg",
              alt: "정리본 21쪽",
              caption: "정리본 p.21 — 굿즈 212 키링·객실 콘센트·캐릭터 모닝콜",
            },
            {
              src: "/sweety/tip-22.jpg",
              alt: "정리본 22쪽",
              caption: "정리본 p.22 — 하선 과정·백투백·플레이스홀더",
            },
            {
              src: "/sweety/tip-23.jpg",
              alt: "정리본 23쪽",
              caption: "정리본 p.23 — 하선 후 그랩 존 안내",
            },
            {
              src: "/sweety/menu-01.jpg",
              alt: "메뉴 한글 번역 1쪽",
              caption: "메뉴 손글씨 번역 p.1 (에니메이터스 팔레트)",
            },
            {
              src: "/sweety/menu-02.jpg",
              alt: "메뉴 한글 번역 2쪽",
              caption: "메뉴 손글씨 번역 p.2",
            },
            {
              src: "/sweety/menu-03.jpg",
              alt: "메뉴 한글 번역 3쪽",
              caption: "메뉴 손글씨 번역 p.3",
            },
            {
              src: "/sweety/menu-04.jpg",
              alt: "메뉴 한글 번역 4쪽",
              caption: "메뉴 손글씨 번역 p.4",
            },
            {
              src: "/sweety/menu-05.jpg",
              alt: "메뉴 한글 번역 5쪽",
              caption: "메뉴 손글씨 번역 p.5",
            },
            {
              src: "/sweety/menu-06.jpg",
              alt: "메뉴 한글 번역 6쪽",
              caption: "메뉴 손글씨 번역 p.6",
            },
            {
              src: "/sweety/menu-07.jpg",
              alt: "메뉴 한글 번역 7쪽",
              caption: "메뉴 손글씨 번역 p.7",
            },
            {
              src: "/sweety/menu-08.jpg",
              alt: "메뉴 한글 번역 8쪽",
              caption: "메뉴 손글씨 번역 p.8",
            },
            {
              src: "/sweety/menu-09.jpg",
              alt: "메뉴 한글 번역 9쪽",
              caption: "메뉴 손글씨 번역 p.9",
            },
            {
              src: "/sweety/menu-10.jpg",
              alt: "메뉴 한글 번역 10쪽",
              caption: "메뉴 손글씨 번역 p.10",
            },
          ],

        },
        {
          title: "🏙️ 싱가포르 전후 1박 — 아이랑 시티 스테이 (숙소·동선 가이드)",
          intro:
            "12/23 도착 1박 + 12/28 하선 1박, 어른 2 + 아이 2 기준 숙소·동선 가이드예요. 일자별 흐름은 위 확정 플랜 표대로 — 여기선 어디에 묵고 어떻게 움직일지를 정해요.",
          steps: [
            {
              heading: "숙소 위치 — 마리나베이·시티홀 시내권으로 확정",
              body: "배에서 내리는 곳은 마리나베이 크루즈 센터(마리나 사우스) — 시내권 호텔까지 택시 5~10분으로 가장 가깝고, 가든스 바이 더 베이·원더랜드·스펙트라 분수쇼가 전부 코앞이라 연말 이벤트 동선이 최강이에요. 12/23과 12/28을 같은 호텔로 잡으면 두 번째 체크인 때 짐도 동선도 익숙해서 하선일이 한결 수월해요.",
            },
            {
              heading: "숙소 — 시내권 패밀리 호텔 4선",
              body: "① 스위소텔 더 스탬포드 (1순위): 4인 가족 가성비 대표 — 객실이 넓고 수영장 2개, 시티홀 MRT·쇼핑몰 직결이라 스콜이 와도 유모차 동선이 실내로 끝나요. ② 콘래드 센테니얼: 체크인 때 아이들에게 테디베어·러버덕을 주는 키즈 웰컴으로 유명 — 터미널 10분, 선텍시티 몰 직결. ③ 마리나베이 샌즈: 인피니티풀과 가든스 도보권 — 연말엔 최고가에 체크인 대기도 길지만, 12/28 하루 '피날레 호캉스'로는 대체 불가예요. ④ 페어몬트 싱가포르: 스위소텔 바로 옆 자매 호텔 — 패밀리룸 구성이 좋고 같은 몰 인프라를 공유해요. 넷 다 12/23·28 재방문 예약에 편한 위치입니다.",
            },
            {
              heading: "12/28 · 하선일 — 짐 맡기고 수영장",
              body: "오전 하선 후 호텔에 짐부터 맡기고(얼리 체크인 요청), 오후는 호텔 수영장·키즈클럽으로 가볍게. 크루즈 직후의 아이들은 이미 '풀충전' 상태라 관광 욕심은 금물이에요. 저녁엔 가든스 바이 더 베이 크리스마스 원더랜드(1/1까지) 또는 오차드로드 라이트업 산책 — 연말 싱가포르의 하이라이트가 딱 이 기간이에요.",
            },
            {
              heading: "12/29 · 귀국일 — 주얼 창이 피날레",
              body: "귀국편 KE644(22:30 출발)가 확정이라 하루가 통째로 남아요. 레이트 체크아웃을 요청하고 공항으로 일찍 이동 — 주얼 창이 자체가 반나절 코스예요. 레인 보텍스 실내 폭포, 캐노피 파크의 미끄럼틀·미로가 미취학에게 딱. 밤 비행이라 아이들은 이륙과 함께 잠들고, 12/31 카운트다운 인파가 몰리기 전에 빠져나오는 일정이라 혼잡 리스크도 낮아요.",
            },
          ],
          links: [
            {
              label: "샹그릴라 vs MBS vs 센토사 — 가족호텔 비교 (호텔몽키)",
              url: "https://hotel-monkey.com/singapore-family-trip-accommodation/",
            },
            {
              label: "스위소텔 더 스탬포드 — 아고다 예약·후기",
              url: "https://www.agoda.com/ko-kr/swissotel-the-stamford-hotel/hotel/singapore-sg.html",
            },
            {
              label: "아이와 싱가포르 더위 피하는 동선 팁 (트립스토어)",
              url: "https://www.tripstore.kr/blog/%EC%8B%B1%EA%B0%80%ED%8F%AC%EB%A5%B4-%EA%B0%80%EC%A1%B1-%EC%97%AC%ED%96%89-%EA%BF%80%ED%8C%81-%EC%9C%A0%EB%AA%A8%EC%B0%A8-%EB%8F%99%EC%84%A0",
            },
            {
              label: "싱가포르 아이들과 베스트 10 (호텔스닷컴)",
              url: "https://kr.hotels.com/go/singapore/best-singapore-kids-things-to-do",
            },
            {
              label: "클룩 — 싱가포르 입장권 검색",
              url: "https://www.klook.com/ko/search/result/?query=%EC%8B%B1%EA%B0%80%ED%8F%AC%EB%A5%B4",
            },
            {
              label: "네이버 블로그 — 싱가포르 12월 아이랑 후기",
              url: naverBlogSearch("싱가포르 12월 아이랑 연말 여행 후기"),
            },
          ],
          note: "12/23·12/28 숙박은 연말 최성수기 — 시내권 패밀리 호텔부터 매진돼요. 항공은 귀국편 확정·가는 편 대기 중이니, 호텔을 무료취소 조건으로 지금 걸어두는 게 다음 순서예요. 12/23은 20:25 도착이라 늦은 체크인을 미리 알려두세요.",
        },
      ],
      gallery: [
        {
        ...
        {
          src: "https://images.unsplash.com/photo-1676679768561-3285849a842a?fm=jpg&q=60&w=3000&auto=format&fit=crop",
          alt: "크루즈 베란다에서 내려다본 바다와 항적",
          caption: "15562 베란다에서 보게 될 풍경 — 수평선과 항적",
        },
        {
          src: "https://images.unsplash.com/photo-1677293814633-f077a5696f52?fm=jpg&q=60&w=3000&auto=format&fit=crop",
          alt: "크루즈 갑판 위로 지는 노을과 사람들",
          caption: "선셋 데크 — 홀리데이 데크 파티의 시간",
        },
      ],
    },
  },
