      ...
      tables: [
        {
          ...
          intro:
            "어른 4 + 아이 3(카시트 2·부스터 1) + 캐리어, 프랑크푸르트→로맨틱 가도→뮌헨 9일 기준이에요.",
          columns: [
            "🚐 렌터카 9인승 (현재 계획)",
            "🚆 기차 + 택시·우버",
            "🔀 혼합 — 기차 + 스팟별 투어",
          ...
          rows: [
            {
              label: "그룹 총 비용 (9일)",
              cells: [
                "약 180~200만원 — 9인승 9일 ~140만 + 유류 ~20만 + 주차 ~25만 + 카시트·부스터 대여",
                "약 70~90만원 — 도이칠란트티켓(월 63유로, 지역열차 무제한) 성인 4 + 7세 1 ≈ 47만 + 역↔숙소 택시 ~30만 · 6세 미만 무료",
                "약 110~130만원 — 지역열차 + 노이슈반슈타인 데이투어(뮌헨 출발) 또는 1일 렌트",
              ],
            },
            {
              label: "동선 자유도",
            ...
            },
            {
              label: "아이 셋과의 현실",
              cells: [
                "카시트 한 번 설치로 끝. 짐·유모차는 트렁크에, 낮잠은 이동 중에 — 사실상 이동식 베이스캠프",
                "환승마다 캐리어 + 유모차 + 아이 셋 — 어른 4명이라 가능은 하지만 체력전. 독일 택시엔 카시트가 없어요",
                "기차 구간은 짐을 최소로, 투어버스는 카시트 제공 여부 사전 확인",
              ],
            },
            {
              label: "겨울 조건",
            ...
            },
            {
              ...
              cells: [
                ...
                "DB Navigator 앱, 도이칠란트티켓은 구독형 — 귀국 후 해지 필수",
            ...
            },
            {
              label: "추천 상황",
              cells: [
                "지금 일정(소도시 3곳 + 짐 많은 가족 이동)엔 이 방식이 정답에 가까움",
                "프랑크푸르트·뷔르츠부르크·뮌헨 대도시 위주로 일정을 재편한다면 최저 비용",
                "운전자를 못 정하겠거나 눈길 운전이 부담이라면 차선책",
              ],
            },
          ],
          note: "우버는 프랑크푸르트·뮌헨 등 대도시에만 있어요 — 로텐부르크·퓌센엔 없습니다. 기차 비용은 지역열차(RE/RB) 기준이며 ICE 이용 시 별도 요금이에요.",
        },
      ],
      flow: [
        {
...
export const COMPARE_ASSUMPTIONS =
  "겨울 시나리오 비용은 2026년 12월 성수기 기준 추정치입니다 (어른 4 + 아이 3·5·7세 두 가족 기준, 가족당 = 전체 ÷ 2). 걷기·트레일 카드는 성인 2인(나 + 친구) 기준 1인당 비용이에요. 실제 가격은 예약 시점·시즌에 따라 크게 달라질 수 있어요.";
