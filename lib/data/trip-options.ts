      ...
      booking: {
        ...
        steps: [
          ...
          },
          {
            ...
            body: "My Reservation의 Cruise Activities 창이 10/10에 열려요(완납 예약만 가능). 열리면 My Plans에서 비비디 바비디 부티크(3~12세, 드레스 포함 $230 수준 · 일찍 잡을수록 드레스를 오래 입어요), 너서리 it's a small world(3세 미만), 성인 스파, 유료 액티비티를 예약 — 미국 시간 기준 오픈이니 한국시간 오픈 시각을 미리 확인하고 알림을 걸어두세요.",
          },
          {
