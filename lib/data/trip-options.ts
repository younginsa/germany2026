      ...
      tables: [
        {
          ...
          rows: [
            ...
            },
            {
              label: "12/24 목 · 승선",
              cells: [
                "오전 머라이언 파크·마리나베이 산책 → 정오 전 터미널행 택시 5~10분 — 일찍 승선해 점심부터 선내 뷔페·수영장. 수영복은 캐리온 가방에!",
              ],
            },
            {
              label: "12/24~28 · 크루즈 4박 ✅",
              cells: [
                "🎄 크리스마스 항차 확정 — 우리 방은 15562 (15층 바다 베란다 · 🕷️ 스파이더맨 테마). 트리 점등식, 산타 그리팅, 12/25 특별 메뉴를 바다 위에서",
              ],
            },
            {
              label: "12/28 월 · 하선",
          ...
          note: "크루즈는 예약 완료 ✅ — 이제 남은 건 ① 항공(12/23 도착·12/29 귀국) ② 호텔 12/23·28 두 밤 (같은 호텔 + 무료취소, 예약 메모에 '크루즈 전후 재방문' 남기기) ③ 원더랜드 날짜 지정 예매. 자세한 순서는 아래 '남은 체크리스트'에.",
        },
        {
